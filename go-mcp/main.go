// Command HubspotConversations-mcp is an MCP server exposing the HubspotConversations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HubspotConversations_list  — list records of an entity
//	HubspotConversations_load  — load a single record of an entity
//
