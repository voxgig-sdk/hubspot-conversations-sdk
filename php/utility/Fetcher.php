...
// HubspotConversations SDK utility: fetcher

class HubspotConversationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HubspotConversationsSDK/1.0)';
    ...
    public static function call(HubspotConversationsContext $ctx, string $fullurl, array $fetchdef): array
    {
