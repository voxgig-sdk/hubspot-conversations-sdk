...
// HubspotConversations SDK utility: graphql
//
...
class HubspotConversationsGraphql
{
    ...
    // equivalent.
    public static function body(HubspotConversationsContext $ctx): mixed
    {
    ...
    public static function errors(HubspotConversationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
