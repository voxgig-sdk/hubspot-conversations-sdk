...
// HubspotConversations SDK utility: feature_init

class HubspotConversationsFeatureInit
{
    public static function call(HubspotConversationsContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
