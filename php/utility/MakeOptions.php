...
// HubspotConversations SDK utility: make_options

class HubspotConversationsMakeOptions
{
    ...
    public static function call(HubspotConversationsContext $ctx): array
    {
        ...
        //
        // `HubspotConversationsSchema::optspec()` is built from the model:
        ...
        $optspec = HubspotConversationsSchema::optspec();
