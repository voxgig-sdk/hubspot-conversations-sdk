...
class ConversationsInboxMessagesPublicMessageContentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_message_content";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicMessageContentEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicMessageContent|array $args ConversationsInboxMessagesPublicMessageContent data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicMessageContent|array The current ConversationsInboxMessagesPublicMessageContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicMessageContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicMessageContent fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicMessageContent.
     *
     * @param ConversationsInboxMessagesPublicMessageContentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicMessageContentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicMessageContent|array The loaded ConversationsInboxMessagesPublicMessageContent as an assoc-array at the
