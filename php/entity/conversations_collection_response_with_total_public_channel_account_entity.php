...
class ConversationsCollectionResponseWithTotalPublicChannelAccountEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_collection_response_with_total_public_channel_account";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsCollectionResponseWithTotalPublicChannelAccountEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsCollectionResponseWithTotalPublicChannelAccount|array $args ConversationsCollectionResponseWithTotalPublicChannelAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsCollectionResponseWithTotalPublicChannelAccount|array The current ConversationsCollectionResponseWithTotalPublicChannelAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsCollectionResponseWithTotalPublicChannelAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsCollectionResponseWithTotalPublicChannelAccount fields).
     */
    ...
    /**
     * List ConversationsCollectionResponseWithTotalPublicChannelAccount items matching the given filter.
     *
     * @param ConversationsCollectionResponseWithTotalPublicChannelAccountListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsCollectionResponseWithTotalPublicChannelAccount fields) as an assoc-array; ConversationsCollectionResponseWithTotalPublicChannelAccountListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsCollectionResponseWithTotalPublicChannelAccount[]|array A list of ConversationsCollectionResponseWithTotalPublicChannelAccount items as assoc-arrays at
     *   the SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
