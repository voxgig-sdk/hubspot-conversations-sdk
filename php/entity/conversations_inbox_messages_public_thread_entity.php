...
// HubspotConversations SDK ConversationsInboxMessagesPublicThread entity
...
class ConversationsInboxMessagesPublicThreadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_thread";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicThreadEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicThread|array $args ConversationsInboxMessagesPublicThread data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicThread|array The current ConversationsInboxMessagesPublicThread data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicThread fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicThread fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicThread.
     *
     * @param ConversationsInboxMessagesPublicThreadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicThreadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicThread|array The loaded ConversationsInboxMessagesPublicThread as an assoc-array at the
    ...
    /**
     * Update an existing ConversationsInboxMessagesPublicThread.
     *
     * @param ConversationsInboxMessagesPublicThreadUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsInboxMessagesPublicThreadUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicThread|array The updated ConversationsInboxMessagesPublicThread as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
