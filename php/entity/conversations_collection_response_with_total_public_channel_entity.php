...
class ConversationsCollectionResponseWithTotalPublicChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_collection_response_with_total_public_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsCollectionResponseWithTotalPublicChannelEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsCollectionResponseWithTotalPublicChannel|array $args ConversationsCollectionResponseWithTotalPublicChannel data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsCollectionResponseWithTotalPublicChannel|array The current ConversationsCollectionResponseWithTotalPublicChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsCollectionResponseWithTotalPublicChannel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsCollectionResponseWithTotalPublicChannel fields).
     */
    ...
    /**
     * List ConversationsCollectionResponseWithTotalPublicChannel items matching the given filter.
     *
     * @param ConversationsCollectionResponseWithTotalPublicChannelListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsCollectionResponseWithTotalPublicChannel fields) as an assoc-array; ConversationsCollectionResponseWithTotalPublicChannelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsCollectionResponseWithTotalPublicChannel[]|array A list of ConversationsCollectionResponseWithTotalPublicChannel items as assoc-arrays at
