...
class ConversationsCollectionResponsePublicThreadForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_collection_response_public_thread_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsCollectionResponsePublicThreadForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsCollectionResponsePublicThreadForwardPaging|array $args ConversationsCollectionResponsePublicThreadForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsCollectionResponsePublicThreadForwardPaging|array The current ConversationsCollectionResponsePublicThreadForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsCollectionResponsePublicThreadForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsCollectionResponsePublicThreadForwardPaging fields).
     */
    ...
    /**
     * List ConversationsCollectionResponsePublicThreadForwardPaging items matching the given filter.
     *
     * @param ConversationsCollectionResponsePublicThreadForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsCollectionResponsePublicThreadForwardPaging fields) as an assoc-array; ConversationsCollectionResponsePublicThreadForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsCollectionResponsePublicThreadForwardPaging[]|array A list of ConversationsCollectionResponsePublicThreadForwardPaging items as assoc-arrays at
