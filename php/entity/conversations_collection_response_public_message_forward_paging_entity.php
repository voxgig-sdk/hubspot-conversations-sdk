...
class ConversationsCollectionResponsePublicMessageForwardPagingEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_collection_response_public_message_forward_paging";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsCollectionResponsePublicMessageForwardPagingEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsCollectionResponsePublicMessageForwardPaging|array $args ConversationsCollectionResponsePublicMessageForwardPaging data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsCollectionResponsePublicMessageForwardPaging|array The current ConversationsCollectionResponsePublicMessageForwardPaging data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsCollectionResponsePublicMessageForwardPaging fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsCollectionResponsePublicMessageForwardPaging fields).
     */
    ...
    /**
     * List ConversationsCollectionResponsePublicMessageForwardPaging items matching the given filter.
     *
     * @param ConversationsCollectionResponsePublicMessageForwardPagingListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsCollectionResponsePublicMessageForwardPaging fields) as an assoc-array; ConversationsCollectionResponsePublicMessageForwardPagingListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsCollectionResponsePublicMessageForwardPaging[]|array A list of ConversationsCollectionResponsePublicMessageForwardPaging items as assoc-arrays at
