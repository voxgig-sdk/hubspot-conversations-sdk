...
class ConversationsInboxMessagesPublicActorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_actor";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicActorEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicActor|array $args ConversationsInboxMessagesPublicActor data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicActor|array The current ConversationsInboxMessagesPublicActor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicActor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicActor fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicActor.
     *
     * @param ConversationsInboxMessagesPublicActorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicActorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicActor|array The loaded ConversationsInboxMessagesPublicActor as an assoc-array at the
