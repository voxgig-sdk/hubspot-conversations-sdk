...
class ConversationsInboxMessagesBatchResponsePublicActorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_batch_response_public_actor";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesBatchResponsePublicActorEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesBatchResponsePublicActor|array $args ConversationsInboxMessagesBatchResponsePublicActor data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesBatchResponsePublicActor|array The current ConversationsInboxMessagesBatchResponsePublicActor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesBatchResponsePublicActor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesBatchResponsePublicActor fields).
     */
    ...
    /**
     * Create a new ConversationsInboxMessagesBatchResponsePublicActor.
     *
     * @param ConversationsInboxMessagesBatchResponsePublicActorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsInboxMessagesBatchResponsePublicActorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesBatchResponsePublicActor|array The created ConversationsInboxMessagesBatchResponsePublicActor as an assoc-array at the
