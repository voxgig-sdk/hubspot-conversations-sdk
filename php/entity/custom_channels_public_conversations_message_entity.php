...
// HubspotConversations SDK CustomChannelsPublicConversationsMessage entity
...
class CustomChannelsPublicConversationsMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_public_conversations_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsPublicConversationsMessageEntity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsPublicConversationsMessage|array $args CustomChannelsPublicConversationsMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomChannelsPublicConversationsMessage|array The current CustomChannelsPublicConversationsMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsPublicConversationsMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomChannelsPublicConversationsMessage fields).
     */
    ...
    /**
     * Load a single CustomChannelsPublicConversationsMessage.
     *
     * @param CustomChannelsPublicConversationsMessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomChannelsPublicConversationsMessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicConversationsMessage|array The loaded CustomChannelsPublicConversationsMessage as an assoc-array at the
    ...
    /**
     * Create a new CustomChannelsPublicConversationsMessage.
     *
     * @param CustomChannelsPublicConversationsMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicConversationsMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicConversationsMessage|array The created CustomChannelsPublicConversationsMessage as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CustomChannelsPublicConversationsMessage.
     *
     * @param CustomChannelsPublicConversationsMessageUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicConversationsMessageUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicConversationsMessage|array The updated CustomChannelsPublicConversationsMessage as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
