...
// HubspotConversations SDK CustomChannelsPublicChannelIntegrationChannel entity
...
class CustomChannelsPublicChannelIntegrationChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_public_channel_integration_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsPublicChannelIntegrationChannelEntity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsPublicChannelIntegrationChannel|array $args CustomChannelsPublicChannelIntegrationChannel data (assoc-array) to store.
     */
    public function data_set($args): void
    {
        if ($args) {
            $this->_data = HubspotConversationsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetData");
        }
    }

    /**
     * @return CustomChannelsPublicChannelIntegrationChannel|array The current CustomChannelsPublicChannelIntegrationChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsPublicChannelIntegrationChannel fields).
     */
    public function match_set($args): void
    {
        if ($args) {
            $this->_match = HubspotConversationsHelpers::to_map(Struct::clone($args)) ?? [];
            ($this->_utility->feature_hook)($this->_entctx, "SetMatch");
        }
    }

    /**
     * @return array The current match filter (any subset of CustomChannelsPublicChannelIntegrationChannel fields).
     */
    ...
    /**
     * Load a single CustomChannelsPublicChannelIntegrationChannel.
     *
     * @param CustomChannelsPublicChannelIntegrationChannelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomChannelsPublicChannelIntegrationChannelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelIntegrationChannel|array The loaded CustomChannelsPublicChannelIntegrationChannel as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = HubspotConversationsHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
    ...
    /**
     * Create a new CustomChannelsPublicChannelIntegrationChannel.
     *
     * @param CustomChannelsPublicChannelIntegrationChannelCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicChannelIntegrationChannelCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelIntegrationChannel|array The created CustomChannelsPublicChannelIntegrationChannel as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CustomChannelsPublicChannelIntegrationChannel.
     *
     * @param CustomChannelsPublicChannelIntegrationChannelUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicChannelIntegrationChannelUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelIntegrationChannel|array The updated CustomChannelsPublicChannelIntegrationChannel as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
