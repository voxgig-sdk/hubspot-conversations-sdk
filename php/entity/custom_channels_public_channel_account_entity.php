...
// HubspotConversations SDK CustomChannelsPublicChannelAccount entity
...
class CustomChannelsPublicChannelAccountEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_public_channel_account";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsPublicChannelAccountEntity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsPublicChannelAccount|array $args CustomChannelsPublicChannelAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomChannelsPublicChannelAccount|array The current CustomChannelsPublicChannelAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsPublicChannelAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomChannelsPublicChannelAccount fields).
     */
    ...
    /**
     * Load a single CustomChannelsPublicChannelAccount.
     *
     * @param CustomChannelsPublicChannelAccountLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CustomChannelsPublicChannelAccountLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelAccount|array The loaded CustomChannelsPublicChannelAccount as an assoc-array at the
    ...
    /**
     * Create a new CustomChannelsPublicChannelAccount.
     *
     * @param CustomChannelsPublicChannelAccountCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicChannelAccountCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelAccount|array The created CustomChannelsPublicChannelAccount as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing CustomChannelsPublicChannelAccount.
     *
     * @param CustomChannelsPublicChannelAccountUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicChannelAccountUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelAccount|array The updated CustomChannelsPublicChannelAccount as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
