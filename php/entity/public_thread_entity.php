...
// HubspotConversations SDK PublicThread entity
...
class PublicThreadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PublicThreadEntity($this->_client, $opts);
    }

    /**
     * @param PublicThread|array $args PublicThread data (assoc-array) to store.
     */
    ...
    /**
     * @return PublicThread|array The current PublicThread data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PublicThread fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PublicThread fields).
     */
    ...
    /**
     * Remove an PublicThread matching the given criteria.
     *
     * @param PublicThreadRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; PublicThreadRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PublicThread|array The removed PublicThread as an assoc-array at the
