...
// HubspotConversations SDK ConversationsPublicChannel entity
...
class ConversationsPublicChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicChannelEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicChannel|array $args ConversationsPublicChannel data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicChannel|array The current ConversationsPublicChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicChannel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicChannel fields).
     */
    ...
    /**
     * Load a single ConversationsPublicChannel.
     *
     * @param ConversationsPublicChannelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicChannelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicChannel|array The loaded ConversationsPublicChannel as an assoc-array at the
