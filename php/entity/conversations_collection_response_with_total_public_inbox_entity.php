...
class ConversationsCollectionResponseWithTotalPublicInboxEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_collection_response_with_total_public_inbox";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsCollectionResponseWithTotalPublicInboxEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsCollectionResponseWithTotalPublicInbox|array $args ConversationsCollectionResponseWithTotalPublicInbox data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsCollectionResponseWithTotalPublicInbox|array The current ConversationsCollectionResponseWithTotalPublicInbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsCollectionResponseWithTotalPublicInbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsCollectionResponseWithTotalPublicInbox fields).
     */
    ...
    /**
     * List ConversationsCollectionResponseWithTotalPublicInbox items matching the given filter.
     *
     * @param ConversationsCollectionResponseWithTotalPublicInboxListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsCollectionResponseWithTotalPublicInbox fields) as an assoc-array; ConversationsCollectionResponseWithTotalPublicInboxListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsCollectionResponseWithTotalPublicInbox[]|array A list of ConversationsCollectionResponseWithTotalPublicInbox items as assoc-arrays at
