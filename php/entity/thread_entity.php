...
// HubspotConversations SDK Thread entity
...
class ThreadEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ThreadEntity($this->_client, $opts);
    }

    /**
     * @param Thread|array $args Thread data (assoc-array) to store.
     */
    ...
    /**
     * @return Thread|array The current Thread data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Thread fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Thread fields).
     */
    ...
    /**
     * Remove an Thread matching the given criteria.
     *
     * @param ThreadRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ThreadRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Thread|array The removed Thread as an assoc-array at the
