...
// HubspotConversations SDK ConversationsPublicThread entity
...
class ConversationsPublicThreadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_thread";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicThreadEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicThread|array $args ConversationsPublicThread data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicThread|array The current ConversationsPublicThread data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicThread fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicThread fields).
     */
    ...
    /**
     * Load a single ConversationsPublicThread.
     *
     * @param ConversationsPublicThreadLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicThreadLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicThread|array The loaded ConversationsPublicThread as an assoc-array at the
    ...
    /**
     * Update an existing ConversationsPublicThread.
     *
     * @param ConversationsPublicThreadUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsPublicThreadUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicThread|array The updated ConversationsPublicThread as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ConversationsPublicThread matching the given criteria.
     *
     * @param ConversationsPublicThreadRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConversationsPublicThreadRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicThread|array The removed ConversationsPublicThread as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
