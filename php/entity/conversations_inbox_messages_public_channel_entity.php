...
class ConversationsInboxMessagesPublicChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicChannelEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicChannel|array $args ConversationsInboxMessagesPublicChannel data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicChannel|array The current ConversationsInboxMessagesPublicChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicChannel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicChannel fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicChannel.
     *
     * @param ConversationsInboxMessagesPublicChannelLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicChannelLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicChannel|array The loaded ConversationsInboxMessagesPublicChannel as an assoc-array at the
