...
class ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_collection_response_with_total_public3";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublic3|array $args ConversationsInboxMessagesCollectionResponseWithTotalPublic3 data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic3|array The current ConversationsInboxMessagesCollectionResponseWithTotalPublic3 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic3 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic3 fields).
     */
    ...
    /**
     * List ConversationsInboxMessagesCollectionResponseWithTotalPublic3 items matching the given filter.
     *
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublic3ListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsInboxMessagesCollectionResponseWithTotalPublic3 fields) as an assoc-array; ConversationsInboxMessagesCollectionResponseWithTotalPublic3ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic3[]|array A list of ConversationsInboxMessagesCollectionResponseWithTotalPublic3 items as assoc-arrays at
