...
class ConversationsBatchResponsePublicActorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_batch_response_public_actor";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsBatchResponsePublicActorEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsBatchResponsePublicActor|array $args ConversationsBatchResponsePublicActor data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsBatchResponsePublicActor|array The current ConversationsBatchResponsePublicActor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsBatchResponsePublicActor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsBatchResponsePublicActor fields).
     */
    ...
    /**
     * Create a new ConversationsBatchResponsePublicActor.
     *
     * @param ConversationsBatchResponsePublicActorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsBatchResponsePublicActorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsBatchResponsePublicActor|array The created ConversationsBatchResponsePublicActor as an assoc-array at the
