...
class CustomChannelsCollectionResponseWithTotalPublicChannel2Entity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_collection_response_with_total_public_channel2";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsCollectionResponseWithTotalPublicChannel2Entity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsCollectionResponseWithTotalPublicChannel2|array $args CustomChannelsCollectionResponseWithTotalPublicChannel2 data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomChannelsCollectionResponseWithTotalPublicChannel2|array The current CustomChannelsCollectionResponseWithTotalPublicChannel2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsCollectionResponseWithTotalPublicChannel2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomChannelsCollectionResponseWithTotalPublicChannel2 fields).
     */
    ...
    /**
     * List CustomChannelsCollectionResponseWithTotalPublicChannel2 items matching the given filter.
     *
     * @param CustomChannelsCollectionResponseWithTotalPublicChannel2ListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomChannelsCollectionResponseWithTotalPublicChannel2 fields) as an assoc-array; CustomChannelsCollectionResponseWithTotalPublicChannel2ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsCollectionResponseWithTotalPublicChannel2[]|array A list of CustomChannelsCollectionResponseWithTotalPublicChannel2 items as assoc-arrays at
