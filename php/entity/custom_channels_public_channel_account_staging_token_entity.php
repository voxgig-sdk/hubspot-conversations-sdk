...
class CustomChannelsPublicChannelAccountStagingTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_public_channel_account_staging_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsPublicChannelAccountStagingTokenEntity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsPublicChannelAccountStagingToken|array $args CustomChannelsPublicChannelAccountStagingToken data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomChannelsPublicChannelAccountStagingToken|array The current CustomChannelsPublicChannelAccountStagingToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsPublicChannelAccountStagingToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomChannelsPublicChannelAccountStagingToken fields).
     */
    ...
    /**
     * Update an existing CustomChannelsPublicChannelAccountStagingToken.
     *
     * @param CustomChannelsPublicChannelAccountStagingTokenUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CustomChannelsPublicChannelAccountStagingTokenUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsPublicChannelAccountStagingToken|array The updated CustomChannelsPublicChannelAccountStagingToken as an assoc-array at the
