...
class CustomChannelsCollectionResponseWithTotalPublicChannelEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "custom_channels_collection_response_with_total_public_channel";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new CustomChannelsCollectionResponseWithTotalPublicChannelEntity($this->_client, $opts);
    }

    /**
     * @param CustomChannelsCollectionResponseWithTotalPublicChannel|array $args CustomChannelsCollectionResponseWithTotalPublicChannel data (assoc-array) to store.
     */
    ...
    /**
     * @return CustomChannelsCollectionResponseWithTotalPublicChannel|array The current CustomChannelsCollectionResponseWithTotalPublicChannel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CustomChannelsCollectionResponseWithTotalPublicChannel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CustomChannelsCollectionResponseWithTotalPublicChannel fields).
     */
    ...
    /**
     * List CustomChannelsCollectionResponseWithTotalPublicChannel items matching the given filter.
     *
     * @param CustomChannelsCollectionResponseWithTotalPublicChannelListMatch|array|null $reqmatch Match filter (any subset
     *   of CustomChannelsCollectionResponseWithTotalPublicChannel fields) as an assoc-array; CustomChannelsCollectionResponseWithTotalPublicChannelListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CustomChannelsCollectionResponseWithTotalPublicChannel[]|array A list of CustomChannelsCollectionResponseWithTotalPublicChannel items as assoc-arrays at
