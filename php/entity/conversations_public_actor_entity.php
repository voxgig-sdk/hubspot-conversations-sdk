...
// HubspotConversations SDK ConversationsPublicActor entity
...
class ConversationsPublicActorEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_actor";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicActorEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicActor|array $args ConversationsPublicActor data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicActor|array The current ConversationsPublicActor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicActor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicActor fields).
     */
    ...
    /**
     * Load a single ConversationsPublicActor.
     *
     * @param ConversationsPublicActorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicActorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicActor|array The loaded ConversationsPublicActor as an assoc-array at the
