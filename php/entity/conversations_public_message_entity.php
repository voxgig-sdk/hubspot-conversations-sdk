...
// HubspotConversations SDK ConversationsPublicMessage entity
...
class ConversationsPublicMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicMessageEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicMessage|array $args ConversationsPublicMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicMessage|array The current ConversationsPublicMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicMessage fields).
     */
    ...
    /**
     * Load a single ConversationsPublicMessage.
     *
     * @param ConversationsPublicMessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicMessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicMessage|array The loaded ConversationsPublicMessage as an assoc-array at the
    ...
    /**
     * Create a new ConversationsPublicMessage.
     *
     * @param ConversationsPublicMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsPublicMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicMessage|array The created ConversationsPublicMessage as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
