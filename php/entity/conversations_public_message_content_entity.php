...
class ConversationsPublicMessageContentEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_message_content";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicMessageContentEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicMessageContent|array $args ConversationsPublicMessageContent data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicMessageContent|array The current ConversationsPublicMessageContent data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicMessageContent fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicMessageContent fields).
     */
    ...
    /**
     * Load a single ConversationsPublicMessageContent.
     *
     * @param ConversationsPublicMessageContentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicMessageContentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicMessageContent|array The loaded ConversationsPublicMessageContent as an assoc-array at the
