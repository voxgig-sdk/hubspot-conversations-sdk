...
class ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_collection_response_with_total_public2";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublic2|array $args ConversationsInboxMessagesCollectionResponseWithTotalPublic2 data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic2|array The current ConversationsInboxMessagesCollectionResponseWithTotalPublic2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic2 fields).
     */
    ...
    /**
     * List ConversationsInboxMessagesCollectionResponseWithTotalPublic2 items matching the given filter.
     *
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublic2ListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsInboxMessagesCollectionResponseWithTotalPublic2 fields) as an assoc-array; ConversationsInboxMessagesCollectionResponseWithTotalPublic2ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic2[]|array A list of ConversationsInboxMessagesCollectionResponseWithTotalPublic2 items as assoc-arrays at
