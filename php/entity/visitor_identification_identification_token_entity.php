...
class VisitorIdentificationIdentificationTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "visitor_identification_identification_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new VisitorIdentificationIdentificationTokenEntity($this->_client, $opts);
    }

    /**
     * @param VisitorIdentificationIdentificationToken|array $args VisitorIdentificationIdentificationToken data (assoc-array) to store.
     */
    ...
    /**
     * @return VisitorIdentificationIdentificationToken|array The current VisitorIdentificationIdentificationToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VisitorIdentificationIdentificationToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VisitorIdentificationIdentificationToken fields).
     */
    ...
    /**
     * Create a new VisitorIdentificationIdentificationToken.
     *
     * @param VisitorIdentificationIdentificationTokenCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VisitorIdentificationIdentificationTokenCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VisitorIdentificationIdentificationToken|array The created VisitorIdentificationIdentificationToken as an assoc-array at the
