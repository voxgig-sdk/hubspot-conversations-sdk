...
// HubspotConversations SDK ConversationsInboxMessagesPublicMessage entity
...
class ConversationsInboxMessagesPublicMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicMessageEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicMessage|array $args ConversationsInboxMessagesPublicMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicMessage|array The current ConversationsInboxMessagesPublicMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicMessage fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicMessage.
     *
     * @param ConversationsInboxMessagesPublicMessageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicMessageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicMessage|array The loaded ConversationsInboxMessagesPublicMessage as an assoc-array at the
    ...
    /**
     * Create a new ConversationsInboxMessagesPublicMessage.
     *
     * @param ConversationsInboxMessagesPublicMessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConversationsInboxMessagesPublicMessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicMessage|array The created ConversationsInboxMessagesPublicMessage as an assoc-array at the
     *   SDK boundary; throws HubspotConversationsError on failure (item-5 convention).
     */
