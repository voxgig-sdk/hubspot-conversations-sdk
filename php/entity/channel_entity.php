...
// HubspotConversations SDK Channel entity
...
class ChannelEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChannelEntity($this->_client, $opts);
    }

    /**
     * @param Channel|array $args Channel data (assoc-array) to store.
     */
    ...
    /**
     * @return Channel|array The current Channel data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Channel fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Channel fields).
     */
     ...
     *
     * @param ChannelRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ChannelRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Channel|array The removed Channel as an assoc-array at the
