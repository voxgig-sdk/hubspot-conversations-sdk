...
class ConversationsInboxMessagesPublicInboxEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_inbox";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicInboxEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicInbox|array $args ConversationsInboxMessagesPublicInbox data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicInbox|array The current ConversationsInboxMessagesPublicInbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicInbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicInbox fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicInbox.
     *
     * @param ConversationsInboxMessagesPublicInboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicInboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicInbox|array The loaded ConversationsInboxMessagesPublicInbox as an assoc-array at the
