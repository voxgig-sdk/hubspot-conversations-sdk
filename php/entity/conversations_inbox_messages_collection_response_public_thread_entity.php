...
class ConversationsInboxMessagesCollectionResponsePublicThreadEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_collection_response_public_thread";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesCollectionResponsePublicThreadEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesCollectionResponsePublicThread|array $args ConversationsInboxMessagesCollectionResponsePublicThread data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesCollectionResponsePublicThread|array The current ConversationsInboxMessagesCollectionResponsePublicThread data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesCollectionResponsePublicThread fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesCollectionResponsePublicThread fields).
     */
    ...
    /**
     * List ConversationsInboxMessagesCollectionResponsePublicThread items matching the given filter.
     *
     * @param ConversationsInboxMessagesCollectionResponsePublicThreadListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsInboxMessagesCollectionResponsePublicThread fields) as an assoc-array; ConversationsInboxMessagesCollectionResponsePublicThreadListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesCollectionResponsePublicThread[]|array A list of ConversationsInboxMessagesCollectionResponsePublicThread items as assoc-arrays at
