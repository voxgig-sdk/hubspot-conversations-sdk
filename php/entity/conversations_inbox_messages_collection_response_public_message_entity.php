...
class ConversationsInboxMessagesCollectionResponsePublicMessageEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_collection_response_public_message";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesCollectionResponsePublicMessageEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesCollectionResponsePublicMessage|array $args ConversationsInboxMessagesCollectionResponsePublicMessage data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesCollectionResponsePublicMessage|array The current ConversationsInboxMessagesCollectionResponsePublicMessage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesCollectionResponsePublicMessage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesCollectionResponsePublicMessage fields).
     */
    ...
    /**
     * List ConversationsInboxMessagesCollectionResponsePublicMessage items matching the given filter.
     *
     * @param ConversationsInboxMessagesCollectionResponsePublicMessageListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsInboxMessagesCollectionResponsePublicMessage fields) as an assoc-array; ConversationsInboxMessagesCollectionResponsePublicMessageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesCollectionResponsePublicMessage[]|array A list of ConversationsInboxMessagesCollectionResponsePublicMessage items as assoc-arrays at
