...
class ConversationsInboxMessagesPublicChannelAccountEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_public_channel_account";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesPublicChannelAccountEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesPublicChannelAccount|array $args ConversationsInboxMessagesPublicChannelAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesPublicChannelAccount|array The current ConversationsInboxMessagesPublicChannelAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesPublicChannelAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesPublicChannelAccount fields).
     */
    ...
    /**
     * Load a single ConversationsInboxMessagesPublicChannelAccount.
     *
     * @param ConversationsInboxMessagesPublicChannelAccountLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsInboxMessagesPublicChannelAccountLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesPublicChannelAccount|array The loaded ConversationsInboxMessagesPublicChannelAccount as an assoc-array at the
