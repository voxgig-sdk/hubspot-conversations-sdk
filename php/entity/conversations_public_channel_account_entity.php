...
class ConversationsPublicChannelAccountEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_channel_account";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicChannelAccountEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicChannelAccount|array $args ConversationsPublicChannelAccount data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicChannelAccount|array The current ConversationsPublicChannelAccount data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicChannelAccount fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicChannelAccount fields).
     */
    ...
    /**
     * Load a single ConversationsPublicChannelAccount.
     *
     * @param ConversationsPublicChannelAccountLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicChannelAccountLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicChannelAccount|array The loaded ConversationsPublicChannelAccount as an assoc-array at the
