...
// HubspotConversations SDK ConversationsPublicInbox entity
...
class ConversationsPublicInboxEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_public_inbox";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsPublicInboxEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsPublicInbox|array $args ConversationsPublicInbox data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsPublicInbox|array The current ConversationsPublicInbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsPublicInbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsPublicInbox fields).
     */
    ...
    /**
     * Load a single ConversationsPublicInbox.
     *
     * @param ConversationsPublicInboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConversationsPublicInboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsPublicInbox|array The loaded ConversationsPublicInbox as an assoc-array at the
