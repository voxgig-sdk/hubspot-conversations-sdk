...
class ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "conversations_inbox_messages_collection_response_with_total_public";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity($this->_client, $opts);
    }

    /**
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublic|array $args ConversationsInboxMessagesCollectionResponseWithTotalPublic data (assoc-array) to store.
     */
    ...
    /**
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic|array The current ConversationsInboxMessagesCollectionResponseWithTotalPublic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConversationsInboxMessagesCollectionResponseWithTotalPublic fields).
     */
    ...
    /**
     * List ConversationsInboxMessagesCollectionResponseWithTotalPublic items matching the given filter.
     *
     * @param ConversationsInboxMessagesCollectionResponseWithTotalPublicListMatch|array|null $reqmatch Match filter (any subset
     *   of ConversationsInboxMessagesCollectionResponseWithTotalPublic fields) as an assoc-array; ConversationsInboxMessagesCollectionResponseWithTotalPublicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConversationsInboxMessagesCollectionResponseWithTotalPublic[]|array A list of ConversationsInboxMessagesCollectionResponseWithTotalPublic items as assoc-arrays at
