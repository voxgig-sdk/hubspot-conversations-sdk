...
// HubspotConversations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HubspotConversationsSDK::test)
...
{
    private const SDK_CLASS = 'HubspotConversationsSDK';
    ...
    private const SDK_BASE = 'hubspotconversations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hubspotconversations_sdk.php';
