...
class HubspotConversationsTestRunner
{
    ...
    {
        $live = self::getenv('HUBSPOT_CONVERSATIONS_TEST_LIVE');
        $override = self::getenv('HUBSPOT_CONVERSATIONS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HUBSPOT_CONVERSATIONS_TEST_EXPLAIN');
...
class_alias('HubspotConversationsTestRunner', 'Runner');
class_alias('HubspotConversationsHelpers', 'Helpers');
