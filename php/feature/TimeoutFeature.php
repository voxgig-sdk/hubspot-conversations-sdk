...
// HubspotConversations SDK timeout feature
...
class HubspotConversationsTimeoutFeature extends HubspotConversationsBaseFeature
{
    ...
    private function _with_timeout(HubspotConversationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HubspotConversationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
