...
// HubspotConversations SDK paging feature
...
class HubspotConversationsPagingFeature extends HubspotConversationsBaseFeature
{
    ...
    private function _graphql_pre_request(HubspotConversationsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(HubspotConversationsContext $ctx): bool
    {
