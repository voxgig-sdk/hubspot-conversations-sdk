...
// HubspotConversations SDK ratelimit feature
...
class HubspotConversationsRatelimitFeature extends HubspotConversationsBaseFeature
{
    ...
    private function _acquire(HubspotConversationsContext $ctx): void
    {
    ...
    private function _track(HubspotConversationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
