...
class HubspotConversationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HubspotConversationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HubspotConversationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HubspotConversationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
