# HubspotConversations SDK feature corpus test
#
...
def _client(kase):
    ...
    HubspotConversationsSDK(...), not HubspotConversationsSDK.test(...): the `test` feature is
    ...
    return HubspotConversationsSDK(opts)
