...
local function make_error_util(ctx, err)
  ...
  local msg = "HubspotConversationsSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = HubspotConversationsError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == HubspotConversationsError then
