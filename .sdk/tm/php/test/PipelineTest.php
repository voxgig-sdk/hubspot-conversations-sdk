...
// HubspotConversations SDK pipeline test
//
...
{
    private static function utility(): HubspotConversationsUtility
    {
        return new HubspotConversationsUtility();
    }
    ...
    private static function ctx(array $over = []): HubspotConversationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HubspotConversationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HubspotConversationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HubspotConversationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HubspotConversationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HubspotConversationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HubspotConversationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HubspotConversationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HubspotConversationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HubspotConversationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotConversationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HubspotConversationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HubspotConversationsResponse([]),
            'result' => new HubspotConversationsResult([]),
        ]);
        [, $err] = HubspotConversationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec([]),
            'response' => null,
            'result' => new HubspotConversationsResult([]),
        ]);
        [, $err] = HubspotConversationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec(['step' => 's']),
            'response' => new HubspotConversationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HubspotConversationsResult([]),
        ]);
        [, $err] = HubspotConversationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec(['step' => 's']),
            'response' => new HubspotConversationsResponse(self::resp(200, ['v' => 1])),
            'result' => new HubspotConversationsResult([]),
        ]);
        [, $err] = HubspotConversationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec(['step' => 's']),
            'response' => new HubspotConversationsResponse(self::resp(200, ['v' => 2])),
            'result' => new HubspotConversationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HubspotConversationsMakeResponse::call($ctx);
    ...
    {
        $preset = new HubspotConversationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec([]),
            'response' => new HubspotConversationsResponse([]),
            'result' => new HubspotConversationsResult([]),
        ...
        [$got, $err] = HubspotConversationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HubspotConversationsResult([])]);
        [, $err] = HubspotConversationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HubspotConversationsSpec([]), 'result' => null]);
        [, $err] = HubspotConversationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotConversationsSpec(['step' => 's']),
            'result' => new HubspotConversationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HubspotConversationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotConversationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HubspotConversationsSpec(['step' => 's']),
            'result' => new HubspotConversationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HubspotConversationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HubspotConversationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HubspotConversationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HubspotConversationsSpec([]),
            'result' => new HubspotConversationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HubspotConversationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotConversationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HubspotConversationsError('boom', 'boom');
        $utility->fetcher = function (HubspotConversationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotConversationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HubspotConversationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HubspotConversationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HubspotConversationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HubspotConversationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HubspotConversationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HubspotConversationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HubspotConversationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HubspotConversationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HubspotConversationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HubspotConversationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HubspotConversationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HubspotConversationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HubspotConversationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HubspotConversationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HubspotConversationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HubspotConversationsResult(['ok' => false])]);
        $this->expectException(HubspotConversationsError::class);
        HubspotConversationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HubspotConversationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HubspotConversationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HubspotConversationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HubspotConversationsBaseFeature();
        $b = new HubspotConversationsBaseFeature();
        HubspotConversationsFeatureAdd::call($ctx, $a);
        HubspotConversationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HubspotConversationsBaseFeature
    {
        $f = new HubspotConversationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HubspotConversationsFeatureAdd::call($ctx, self::named_feature('a'));
        HubspotConversationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        HubspotConversationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        HubspotConversationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        HubspotConversationsFeatureAdd::call($ctx, $replace);
        ...
        HubspotConversationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HubspotConversationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HubspotConversationsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HubspotConversationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HubspotConversationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HubspotConversationsResponse(['headers' => null]),
            'result' => new HubspotConversationsResult([]),
        ]);
        HubspotConversationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HubspotConversationsResultBody::call($ctx);
