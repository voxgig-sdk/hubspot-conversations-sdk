...
// HubspotConversations SDK utility type

class HubspotConversationsUtility
{
    ...
    public static function copy(HubspotConversationsUtility $src): HubspotConversationsUtility
    {
        $u = new HubspotConversationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
