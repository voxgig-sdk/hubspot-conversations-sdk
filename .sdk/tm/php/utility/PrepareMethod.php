...
// HubspotConversations SDK utility: prepare_method

class HubspotConversationsPrepareMethod
{
    ...
    public static function call(HubspotConversationsContext $ctx): ?string
    {
