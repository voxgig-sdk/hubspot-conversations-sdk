...
|---|---|---|
| `js/` | @voxgig-sdk/hubspot-conversations-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/hubspot-conversations | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hubspot-conversations-js \
      --repository voxgig-sdk/hubspot-conversations-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hubspot-conversations-js` shows it, and
`npm trust revoke @voxgig-sdk/hubspot-conversations-js --id=<id>` removes it.
