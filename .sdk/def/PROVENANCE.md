...
## hubspot-conversations-openapi.json

- **Source:** https://github.com/HubSpot/HubSpot-public-api-spec-collection
  (`PublicApiSpecs/Conversations/*/Rollouts/*/<version>/*.json`)
- **Publisher:** HubSpot (the official HubSpot-maintained spec collection)
- **Retrieved:** 2026-09-17
- **Format:** OpenAPI 3.0.1
- **Size:** 273517 bytes
- **Coverage:** every API HubSpot publishes under **Conversations** — 4 document(s),
  merged to 35 paths and 187 component schemas.

## Why this is a merge, and one SDK per product group

HubSpot publishes **140** separate OpenAPI documents, one per API, grouped by
product (Conversations is one such group). One SDK per document would be 140 SDKs;
