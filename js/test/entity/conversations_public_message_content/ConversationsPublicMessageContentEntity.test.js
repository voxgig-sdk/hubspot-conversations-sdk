...
describe('ConversationsPublicMessageContentEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    const conversations_public_message_content_ref01_match_dt0 = {}
    const conversations_public_message_content_ref01_data_dt0 = (await conversations_public_message_content_ref01_ent.load(conversations_public_message_content_ref01_match_dt0)).data()
    assert(null != conversations_public_message_content_ref01_data_dt0)
