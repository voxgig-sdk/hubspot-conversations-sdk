# HubspotConversations JavaScript SDK Reference

Complete API reference for the HubspotConversations JavaScript SDK.
...
```ts
const results = await client.ConversationsCollectionResponsePublicMessageForwardPaging().list()
```
...
```ts
const results = await client.ConversationsInboxMessagesCollectionResponsePublicMessage().list()
```
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `capabilities` | `Object` | Yes | An object detailing the capabilities of the channel, with additional properties as objects. |
...
```ts
const results = await client.CustomChannelsCollectionResponseWithTotalPublicChannel2().list()
```
...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `capabilities` | `Object` | Yes | An object that defines the capabilities of the channel, with additional properties as key-value pairs. |
...
| `preResolvedContacts` | `Object` | Yes |  |
...
| `hsCustomerAgentContext` | `Object` | Yes | An object containing additional context about the customer agent. |
