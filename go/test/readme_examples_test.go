...
const testSeed = `map[string]any{"entity": map[string]any{"channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_batch_response_public_actor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_collection_response_public_message_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_collection_response_public_thread_forward_paging": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_collection_response_with_total_public_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_collection_response_with_total_public_channel_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_collection_response_with_total_public_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_batch_response_public_actor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_collection_response_public_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_collection_response_public_thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_collection_response_with_total_public": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_collection_response_with_total_public2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_collection_response_with_total_public3": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_actor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_channel_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_message_content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_inbox_messages_public_thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_actor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_channel_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_inbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_message_content": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversations_public_thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_collection_response_with_total_public_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_collection_response_with_total_public_channel2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_public_channel_account": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_public_channel_account_staging_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_public_channel_integration_channel": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "custom_channels_public_conversations_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "public_thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "thread": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "visitor_identification_identification_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
