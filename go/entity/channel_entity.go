...
func NewChannelEntity(client *core.HubspotConversationsSDK, entopts map[string]any) *ChannelEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ChannelEntity) GetName() string { return e.name }
...
func (e *ChannelEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ChannelEntity) Deleted() bool {
	return e.deleted
}


func (e *ChannelEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewChannelEntity(e.client, opts)
}

func (e *ChannelEntity) Data(args ...any) any {
...
func (e *ChannelEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Channel; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ChannelEntity) DataTyped(data ...Channel) Channel {
	if len(data) > 0 {
		return typedFrom[Channel](e.Data(asMap(data[0])))
	}
	return typedFrom[Channel](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Channel (all fields
// optional at the wire level).
func (e *ChannelEntity) MatchTyped(match ...Channel) Channel {
	if len(match) > 0 {
		return typedFrom[Channel](e.Match(asMap(match[0])))
	}
	return typedFrom[Channel](e.Match())
}
...
func (e *ChannelEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ChannelEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ChannelEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ChannelEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ChannelEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ChannelEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ChannelRemoveMatch and returns an Channel. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ChannelEntity) RemoveTyped(reqmatch ChannelRemoveMatch, ctrl map[string]any) (Channel, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return Channel{}, err
	}
	return typedFrom[Channel](res), nil
}



func (e *ChannelEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
