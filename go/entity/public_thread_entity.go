...
type PublicThreadEntity struct {
	name    string
...
func NewPublicThreadEntity(client *core.HubspotConversationsSDK, entopts map[string]any) *PublicThreadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PublicThreadEntity) GetName() string { return e.name }
...
func (e *PublicThreadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PublicThreadEntity) Deleted() bool {
	return e.deleted
}


func (e *PublicThreadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPublicThreadEntity(e.client, opts)
}

func (e *PublicThreadEntity) Data(args ...any) any {
...
func (e *PublicThreadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an PublicThread; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PublicThreadEntity) DataTyped(data ...PublicThread) PublicThread {
	if len(data) > 0 {
		return typedFrom[PublicThread](e.Data(asMap(data[0])))
	}
	return typedFrom[PublicThread](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through PublicThread (all fields
// optional at the wire level).
func (e *PublicThreadEntity) MatchTyped(match ...PublicThread) PublicThread {
	if len(match) > 0 {
		return typedFrom[PublicThread](e.Match(asMap(match[0])))
	}
	return typedFrom[PublicThread](e.Match())
}
...
func (e *PublicThreadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PublicThreadEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *PublicThreadEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PublicThreadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PublicThreadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *PublicThreadEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PublicThreadRemoveMatch and returns an PublicThread. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *PublicThreadEntity) RemoveTyped(reqmatch PublicThreadRemoveMatch, ctrl map[string]any) (PublicThread, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return PublicThread{}, err
	}
	return typedFrom[PublicThread](res), nil
}



func (e *PublicThreadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
