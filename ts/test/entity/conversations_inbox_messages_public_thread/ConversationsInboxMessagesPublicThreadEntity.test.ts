...
describe('ConversationsInboxMessagesPublicThreadEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    for (const op of ['update', 'load']) {
      if (!live && maybeSkipControl(t, 'entityOp', 'conversations_inbox_messages_public_thread.' + op, live)) return
    }
    ...
    let conversations_inbox_messages_public_thread_ref01_data = Object.values(setup.data.existing.conversations_inbox_messages_public_thread)[0] as any

    // UPDATE
    const conversations_inbox_messages_public_thread_ref01_ent = client.ConversationsInboxMessagesPublicThread()
    const conversations_inbox_messages_public_thread_ref01_data_up0: any = {}
    ...
    ;(conversations_inbox_messages_public_thread_ref01_data_up0 as any)[conversations_inbox_messages_public_thread_ref01_markdef_up0.name] = conversations_inbox_messages_public_thread_ref01_markdef_up0.value
    ...
    assert((conversations_inbox_messages_public_thread_ref01_resdata_up0 as any)[conversations_inbox_messages_public_thread_ref01_markdef_up0.name] === conversations_inbox_messages_public_thread_ref01_markdef_up0.value)


    // LOAD
    const conversations_inbox_messages_public_thread_ref01_match_dt0: any = {}
