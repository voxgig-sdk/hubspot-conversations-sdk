...
(0, node_test_1.describe)('ConversationsPublicChannelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(conversations_public_channel_ref01_data_dt0.id === conversations_public_channel_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_public_channel/ConversationsPublicChannelTestData.json');
    ...
    let idmap = transform(['conversations_public_channel01', 'conversations_public_channel02', 'conversations_public_channel03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsPublicChannelEntity.test.js.map