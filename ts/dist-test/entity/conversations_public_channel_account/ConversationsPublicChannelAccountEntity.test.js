...
(0, node_test_1.describe)('ConversationsPublicChannelAccountEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'conversations_public_channel_account.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(conversations_public_channel_account_ref01_data_dt0.id === conversations_public_channel_account_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_public_channel_account/ConversationsPublicChannelAccountTestData.json');
    ...
    let idmap = transform(['conversations_public_channel_account01', 'conversations_public_channel_account02', 'conversations_public_channel_account03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsPublicChannelAccountEntity.test.js.map