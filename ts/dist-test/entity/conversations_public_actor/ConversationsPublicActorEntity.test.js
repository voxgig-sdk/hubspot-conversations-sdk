...
(0, node_test_1.describe)('ConversationsPublicActorEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'conversations_public_actor.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(conversations_public_actor_ref01_data_dt0.id === conversations_public_actor_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_public_actor/ConversationsPublicActorTestData.json');
    ...
    let idmap = transform(['conversations_public_actor01', 'conversations_public_actor02', 'conversations_public_actor03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsPublicActorEntity.test.js.map