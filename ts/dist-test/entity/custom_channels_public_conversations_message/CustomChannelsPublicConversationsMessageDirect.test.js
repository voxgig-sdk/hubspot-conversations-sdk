...
(0, node_test_1.describe)('CustomChannelsPublicConversationsMessageDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_channels_public_conversations_message', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_channels_public_conversations_message', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["channel_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CUSTOM_CHANNELS_PUBLIC_CONVERSATIONS_MESSAGE_ENTID'];
...
//# sourceMappingURL=CustomChannelsPublicConversationsMessageDirect.test.js.map