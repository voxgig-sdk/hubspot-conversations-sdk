...
(0, node_test_1.describe)('VisitorIdentificationIdentificationTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != visitor_identification_identification_token_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/visitor_identification_identification_token/VisitorIdentificationIdentificationTokenTestData.json');
    ...
    let idmap = transform(['visitor_identification_identification_token01', 'visitor_identification_identification_token02', 'visitor_identification_identification_token03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=VisitorIdentificationIdentificationTokenEntity.test.js.map