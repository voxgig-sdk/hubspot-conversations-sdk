...
(0, node_test_1.describe)('CustomChannelsCollectionResponseWithTotalPublicChannel2Direct', async () => {
    ...
    (0, node_test_1.test)('direct-list-custom_channels_collection_response_with_total_public_channel2', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_channels_collection_response_with_total_public_channel2', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["channel01"]))
            return;
...
//# sourceMappingURL=CustomChannelsCollectionResponseWithTotalPublicChannel2Direct.test.js.map