...
(0, node_test_1.describe)('CustomChannelsCollectionResponseWithTotalPublicChannel2Entity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        const custom_channels_collection_response_with_total_public_channel2_ref01_match = {};
        custom_channels_collection_response_with_total_public_channel2_ref01_match['channel_id'] = setup.idmap['channel01'];
        const custom_channels_collection_response_with_total_public_channel2_ref01_list = (await custom_channels_collection_response_with_total_public_channel2_ref01_ent.list(custom_channels_collection_response_with_total_public_channel2_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/custom_channels_collection_response_with_total_public_channel2/CustomChannelsCollectionResponseWithTotalPublicChannel2TestData.json');
    ...
    let idmap = transform(['custom_channels_collection_response_with_total_public_channel201', 'custom_channels_collection_response_with_total_public_channel202', 'custom_channels_collection_response_with_total_public_channel203', '2026_0901', '2026_0902', '2026_0903'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=CustomChannelsCollectionResponseWithTotalPublicChannel2Entity.test.js.map