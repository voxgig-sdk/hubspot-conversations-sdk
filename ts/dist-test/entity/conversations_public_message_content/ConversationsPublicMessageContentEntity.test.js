...
function basicSetup(extra) {
    ...
    let idmap = transform(['conversations_public_message_content01', 'conversations_public_message_content02', 'conversations_public_message_content03', 'thread01', 'thread02', 'thread03', 'message01', 'message02', 'message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
