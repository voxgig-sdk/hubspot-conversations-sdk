...
(0, node_test_1.describe)('ConversationsPublicMessageContentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-conversations_public_message_content', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conversations_public_message_content', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["message_id01", "thread_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CONVERSATIONS_PUBLIC_MESSAGE_CONTENT_ENTID'];
...
//# sourceMappingURL=ConversationsPublicMessageContentDirect.test.js.map