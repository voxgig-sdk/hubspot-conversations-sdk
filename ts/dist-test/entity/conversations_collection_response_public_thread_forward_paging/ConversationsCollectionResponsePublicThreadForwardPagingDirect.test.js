...
(0, node_test_1.describe)('ConversationsCollectionResponsePublicThreadForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-conversations_collection_response_public_thread_forward_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversations_collection_response_public_thread_forward_paging', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CONVERSATIONS_COLLECTION_RESPONSE_PUBLIC_THREAD_FORWARD_PAGING_ENTID'];
...
//# sourceMappingURL=ConversationsCollectionResponsePublicThreadForwardPagingDirect.test.js.map