...
(0, node_test_1.describe)('CustomChannelsPublicChannelIntegrationChannelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-custom_channels_public_channel_integration_channel', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-custom_channels_public_channel_integration_channel', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["channel_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CUSTOM_CHANNELS_PUBLIC_CHANNEL_INTEGRATION_CHANNEL_ENTID'];
...
//# sourceMappingURL=CustomChannelsPublicChannelIntegrationChannelDirect.test.js.map