...
(0, node_test_1.describe)('ConversationsInboxMessagesPublicMessageContentEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_inbox_messages_public_message_content/ConversationsInboxMessagesPublicMessageContentTestData.json');
    ...
    let idmap = transform(['conversations_inbox_messages_public_message_content01', 'conversations_inbox_messages_public_message_content02', 'conversations_inbox_messages_public_message_content03', 'thread01', 'thread02', 'thread03', 'message01', 'message02', 'message03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsInboxMessagesPublicMessageContentEntity.test.js.map