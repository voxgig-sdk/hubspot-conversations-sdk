...
(0, node_test_1.describe)('PublicThreadEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/public_thread/PublicThreadTestData.json');
    ...
    let idmap = transform(['public_thread01', 'public_thread02', 'public_thread03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'HUBSPOT_CONVERSATIONS_TEST_PUBLIC_THREAD_ENTID': idmap,
        'HUBSPOT_CONVERSATIONS_TEST_LIVE': 'FALSE',
        'HUBSPOT_CONVERSATIONS_TEST_EXPLAIN': 'FALSE',
        'HUBSPOT_CONVERSATIONS_APIKEY': '',
    });
    idmap = env['HUBSPOT_CONVERSATIONS_TEST_PUBLIC_THREAD_ENTID'];
    const live = 'TRUE' === env.HUBSPOT_CONVERSATIONS_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['HUBSPOT_CONVERSATIONS_TEST_PUBLIC_THREAD_ENTID'];
...
//# sourceMappingURL=PublicThreadEntity.test.js.map