...
(0, node_test_1.describe)('CustomChannelsCollectionResponseWithTotalPublicChannelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-custom_channels_collection_response_with_total_public_channel', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-custom_channels_collection_response_with_total_public_channel', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CUSTOM_CHANNELS_COLLECTION_RESPONSE_WITH_TOTAL_PUBLIC_CHANNEL_ENTID'];
...
//# sourceMappingURL=CustomChannelsCollectionResponseWithTotalPublicChannelDirect.test.js.map