...
(0, node_test_1.describe)('ConversationsInboxMessagesPublicChannelDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-conversations_inbox_messages_public_channel', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-conversations_inbox_messages_public_channel', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CONVERSATIONS_INBOX_MESSAGES_PUBLIC_CHANNEL_ENTID'];
...
//# sourceMappingURL=ConversationsInboxMessagesPublicChannelDirect.test.js.map