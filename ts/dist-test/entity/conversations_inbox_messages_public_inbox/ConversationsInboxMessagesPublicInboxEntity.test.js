...
(0, node_test_1.describe)('ConversationsInboxMessagesPublicInboxEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'conversations_inbox_messages_public_inbox.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(conversations_inbox_messages_public_inbox_ref01_data_dt0.id === conversations_inbox_messages_public_inbox_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_inbox_messages_public_inbox/ConversationsInboxMessagesPublicInboxTestData.json');
    ...
    let idmap = transform(['conversations_inbox_messages_public_inbox01', 'conversations_inbox_messages_public_inbox02', 'conversations_inbox_messages_public_inbox03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsInboxMessagesPublicInboxEntity.test.js.map