...
(0, node_test_1.describe)('ConversationsCollectionResponseWithTotalPublicChannelEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'conversations_collection_response_with_total_public_channel.' + op, live))
                return;
        }
        ...
        let conversations_collection_response_with_total_public_channel_ref01_data = Object.values(setup.data.existing.conversations_collection_response_with_total_public_channel)[0];
        // LIST
        ...
        const conversations_collection_response_with_total_public_channel_ref01_match = {};
        const conversations_collection_response_with_total_public_channel_ref01_list = (await conversations_collection_response_with_total_public_channel_ref01_ent.list(conversations_collection_response_with_total_public_channel_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_collection_response_with_total_public_channel/ConversationsCollectionResponseWithTotalPublicChannelTestData.json');
    ...
    let idmap = transform(['conversations_collection_response_with_total_public_channel01', 'conversations_collection_response_with_total_public_channel02', 'conversations_collection_response_with_total_public_channel03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsCollectionResponseWithTotalPublicChannelEntity.test.js.map