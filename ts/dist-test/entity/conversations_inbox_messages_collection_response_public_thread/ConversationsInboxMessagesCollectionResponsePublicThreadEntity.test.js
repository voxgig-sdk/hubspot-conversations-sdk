...
(0, node_test_1.describe)('ConversationsInboxMessagesCollectionResponsePublicThreadEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/conversations_inbox_messages_collection_response_public_thread/ConversationsInboxMessagesCollectionResponsePublicThreadTestData.json');
    ...
    let idmap = transform(['conversations_inbox_messages_collection_response_public_thread01', 'conversations_inbox_messages_collection_response_public_thread02', 'conversations_inbox_messages_collection_response_public_thread03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConversationsInboxMessagesCollectionResponsePublicThreadEntity.test.js.map