...
(0, node_test_1.describe)('ConversationsInboxMessagesCollectionResponsePublicThreadDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-conversations_inbox_messages_collection_response_public_thread', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversations_inbox_messages_collection_response_public_thread', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CONVERSATIONS_INBOX_MESSAGES_COLLECTION_RESPONSE_PUBLIC_THREAD_ENTID'];
...
//# sourceMappingURL=ConversationsInboxMessagesCollectionResponsePublicThreadDirect.test.js.map