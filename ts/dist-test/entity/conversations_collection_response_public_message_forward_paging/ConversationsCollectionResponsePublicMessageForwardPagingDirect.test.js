...
(0, node_test_1.describe)('ConversationsCollectionResponsePublicMessageForwardPagingDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HubspotConversationsSDK({
    ...
    (0, node_test_1.test)('direct-list-conversations_collection_response_public_message_forward_paging', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-conversations_collection_response_public_message_forward_paging', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["thread01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HubspotConversationsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HUBSPOT_CONVERSATIONS_APIKEY,
        }));
        let idmap = env['HUBSPOT_CONVERSATIONS_TEST_CONVERSATIONS_COLLECTION_RESPONSE_PUBLIC_MESSAGE_FORWARD_PAGING_ENTID'];
    ...
    const client = new __1.HubspotConversationsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ConversationsCollectionResponsePublicMessageForwardPagingDirect.test.js.map