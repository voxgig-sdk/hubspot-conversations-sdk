...
const __1 = require("..");
const SDK_NAME = 'HubspotConversationsSDK';
...
const TEST_SEED = { "entity": { "channel": { "test01": { "id": "test01" } }, "conversations_batch_response_public_actor": { "test01": { "id": "test01" } }, "conversations_collection_response_public_message_forward_paging": { "test01": { "id": "test01" } }, "conversations_collection_response_public_thread_forward_paging": { "test01": { "id": "test01" } }, "conversations_collection_response_with_total_public_channel": { "test01": { "id": "test01" } }, "conversations_collection_response_with_total_public_channel_account": { "test01": { "id": "test01" } }, "conversations_collection_response_with_total_public_inbox": { "test01": { "id": "test01" } }, "conversations_inbox_messages_batch_response_public_actor": { "test01": { "id": "test01" } }, "conversations_inbox_messages_collection_response_public_message": { "test01": { "id": "test01" } }, "conversations_inbox_messages_collection_response_public_thread": { "test01": { "id": "test01" } }, "conversations_inbox_messages_collection_response_with_total_public": { "test01": { "id": "test01" } }, "conversations_inbox_messages_collection_response_with_total_public2": { "test01": { "id": "test01" } }, "conversations_inbox_messages_collection_response_with_total_public3": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_actor": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_channel": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_channel_account": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_inbox": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_message": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_message_content": { "test01": { "id": "test01" } }, "conversations_inbox_messages_public_thread": { "test01": { "id": "test01" } }, "conversations_public_actor": { "test01": { "id": "test01" } }, "conversations_public_channel": { "test01": { "id": "test01" } }, "conversations_public_channel_account": { "test01": { "id": "test01" } }, "conversations_public_inbox": { "test01": { "id": "test01" } }, "conversations_public_message": { "test01": { "id": "test01" } }, "conversations_public_message_content": { "test01": { "id": "test01" } }, "conversations_public_thread": { "test01": { "id": "test01" } }, "custom_channels_collection_response_with_total_public_channel": { "test01": { "id": "test01" } }, "custom_channels_collection_response_with_total_public_channel2": { "test01": { "id": "test01" } }, "custom_channels_public_channel_account": { "test01": { "id": "test01" } }, "custom_channels_public_channel_account_staging_token": { "test01": { "id": "test01" } }, "custom_channels_public_channel_integration_channel": { "test01": { "id": "test01" } }, "custom_channels_public_conversations_message": { "test01": { "id": "test01" } }, "public_thread": { "test01": { "id": "test01" } }, "thread": { "test01": { "id": "test01" } }, "visitor_identification_identification_token": { "test01": { "id": "test01" } } } };
...
function isRunnable(code) {
    return (/new\s+HubspotConversationsSDK\b/.test(code) ||
        /\bHubspotConversationsSDK\.test\b/.test(code) ||
        /\bclient\s*\./.test(code));
}
...
function rewriteForRun(code) {
    ...
    out = out.replace(/new\s+HubspotConversationsSDK\s*\([^)]*\)/g, () => SEEDED_CTOR);
    out = out.replace(/HubspotConversationsSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR);
