...
import type {
  PublicThread,
  PublicThreadRemoveMatch,
} from '../HubspotConversationsTypes'

// TODO: needs Entity superclass
class PublicThreadEntity extends HubspotConversationsEntityBase<PublicThread> {

  constructor(client: HubspotConversationsSDK, entopts: any) {
    super(client, entopts)
    this.name = 'public_thread'
    this.name_ = 'public_thread'
    this.Name = 'PublicThread'
  }


  make(this: PublicThreadEntity) {
    return new PublicThreadEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: PublicThreadRemoveMatch, ctrl?: Control,
  ): Promise<PublicThreadEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<PublicThreadEntity> return stays clean under strict null checks.
