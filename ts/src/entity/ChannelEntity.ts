...
class ChannelEntity extends HubspotConversationsEntityBase<Channel> {
  ...
  make(this: ChannelEntity) {
    return new ChannelEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: ChannelRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ChannelEntity> return stays clean under strict null checks.
