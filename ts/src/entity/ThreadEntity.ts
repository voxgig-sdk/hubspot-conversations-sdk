...
class ThreadEntity extends HubspotConversationsEntityBase<Thread> {
  ...
  make(this: ThreadEntity) {
    return new ThreadEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: ThreadRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<ThreadEntity> return stays clean under strict null checks.
