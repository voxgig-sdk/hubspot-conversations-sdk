# HubspotConversations TypeScript SDK



The TypeScript SDK for the HubspotConversations API — a type-safe, entity-oriented client with full async/await support.
...
| Field | Type | Description |
| --- | --- | --- |
| `capabilities` | `Record<string, any>` | An object detailing the capabilities of the channel, with additional properties as objects. |
...
| Field | Type | Description |
| --- | --- | --- |
| `capabilities` | `Record<string, any>` | An object that defines the capabilities of the channel, with additional properties as key-value pairs. |
...
| `hsCustomerAgentContext` | `Record<string, any>` | An object containing additional context about the customer agent. |
...
├── src/
│   ├── HubspotConversationsSDK.ts        # Main SDK class
