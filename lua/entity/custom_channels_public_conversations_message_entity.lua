...
local CustomChannelsPublicConversationsMessageEntity = {}
CustomChannelsPublicConversationsMessageEntity.__index = CustomChannelsPublicConversationsMessageEntity


function CustomChannelsPublicConversationsMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsPublicConversationsMessageEntity)
  self._name = "custom_channels_public_conversations_message"
  self._client = client
...
function CustomChannelsPublicConversationsMessageEntity:get_name()
  return self._name
end


function CustomChannelsPublicConversationsMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsPublicConversationsMessageEntity.new(self._client, opts)
end
...
function CustomChannelsPublicConversationsMessageEntity:mark_deleted()
  self._deleted = true
end


function CustomChannelsPublicConversationsMessageEntity:deleted()
  return true == self._deleted
end


function CustomChannelsPublicConversationsMessageEntity:data_set(args)
  if args ~= nil then
...
function CustomChannelsPublicConversationsMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsPublicConversationsMessageEntity:match_set(args)
  if args ~= nil then
...
function CustomChannelsPublicConversationsMessageEntity:match_get()
...
function CustomChannelsPublicConversationsMessageEntity:stream(action, args, callopts)
...
---@param reqmatch CustomChannelsPublicConversationsMessageLoadMatch
---@param ctrl? table
---@return CustomChannelsPublicConversationsMessage
---@return string? err
function CustomChannelsPublicConversationsMessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CustomChannelsPublicConversationsMessageCreateData
---@param ctrl? table
---@return CustomChannelsPublicConversationsMessage
---@return string? err
function CustomChannelsPublicConversationsMessageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CustomChannelsPublicConversationsMessageUpdateData
---@param ctrl? table
---@return CustomChannelsPublicConversationsMessage
---@return string? err
function CustomChannelsPublicConversationsMessageEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CustomChannelsPublicConversationsMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsPublicConversationsMessageEntity
