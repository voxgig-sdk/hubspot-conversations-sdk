-- HubspotConversations SDK ConversationsInboxMessagesPublicChannelAccount entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesPublicChannelAccountEntity = {}
ConversationsInboxMessagesPublicChannelAccountEntity.__index = ConversationsInboxMessagesPublicChannelAccountEntity


function ConversationsInboxMessagesPublicChannelAccountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicChannelAccountEntity)
  self._name = "conversations_inbox_messages_public_channel_account"
  self._client = client
...
function ConversationsInboxMessagesPublicChannelAccountEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicChannelAccountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicChannelAccountEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicChannelAccountEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicChannelAccountEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicChannelAccountEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicChannelAccountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicChannelAccountEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicChannelAccountEntity:match_get()
...
function ConversationsInboxMessagesPublicChannelAccountEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicChannelAccountLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicChannelAccount
---@return string? err
function ConversationsInboxMessagesPublicChannelAccountEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesPublicChannelAccountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicChannelAccountEntity
