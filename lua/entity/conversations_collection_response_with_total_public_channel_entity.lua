-- HubspotConversations SDK ConversationsCollectionResponseWithTotalPublicChannel entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsCollectionResponseWithTotalPublicChannelEntity = {}
ConversationsCollectionResponseWithTotalPublicChannelEntity.__index = ConversationsCollectionResponseWithTotalPublicChannelEntity


function ConversationsCollectionResponseWithTotalPublicChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsCollectionResponseWithTotalPublicChannelEntity)
  self._name = "conversations_collection_response_with_total_public_channel"
  self._client = client
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:get_name()
  return self._name
end


function ConversationsCollectionResponseWithTotalPublicChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsCollectionResponseWithTotalPublicChannelEntity.new(self._client, opts)
end
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:mark_deleted()
  self._deleted = true
end


function ConversationsCollectionResponseWithTotalPublicChannelEntity:deleted()
  return true == self._deleted
end


function ConversationsCollectionResponseWithTotalPublicChannelEntity:data_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsCollectionResponseWithTotalPublicChannelEntity:match_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:match_get()
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsCollectionResponseWithTotalPublicChannelListMatch
---@param ctrl? table
---@return ConversationsCollectionResponseWithTotalPublicChannel[]
---@return string? err
function ConversationsCollectionResponseWithTotalPublicChannelEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsCollectionResponseWithTotalPublicChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsCollectionResponseWithTotalPublicChannelEntity
