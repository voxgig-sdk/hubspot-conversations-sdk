-- HubspotConversations SDK ConversationsInboxMessagesCollectionResponseWithTotalPublic entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity = {}
ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity.__index = ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity


function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity)
  self._name = "conversations_inbox_messages_collection_response_with_total_public"
  self._client = client
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:match_get()
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesCollectionResponseWithTotalPublicListMatch
---@param ctrl? table
---@return ConversationsInboxMessagesCollectionResponseWithTotalPublic[]
---@return string? err
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity
