-- HubspotConversations SDK ConversationsInboxMessagesPublicMessageContent entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesPublicMessageContentEntity = {}
ConversationsInboxMessagesPublicMessageContentEntity.__index = ConversationsInboxMessagesPublicMessageContentEntity


function ConversationsInboxMessagesPublicMessageContentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicMessageContentEntity)
  self._name = "conversations_inbox_messages_public_message_content"
  self._client = client
...
function ConversationsInboxMessagesPublicMessageContentEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicMessageContentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicMessageContentEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicMessageContentEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicMessageContentEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicMessageContentEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicMessageContentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicMessageContentEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicMessageContentEntity:match_get()
...
function ConversationsInboxMessagesPublicMessageContentEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicMessageContentLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicMessageContent
---@return string? err
function ConversationsInboxMessagesPublicMessageContentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesPublicMessageContentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicMessageContentEntity
