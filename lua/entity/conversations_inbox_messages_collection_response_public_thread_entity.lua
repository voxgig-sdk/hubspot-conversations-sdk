-- HubspotConversations SDK ConversationsInboxMessagesCollectionResponsePublicThread entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesCollectionResponsePublicThreadEntity = {}
ConversationsInboxMessagesCollectionResponsePublicThreadEntity.__index = ConversationsInboxMessagesCollectionResponsePublicThreadEntity


function ConversationsInboxMessagesCollectionResponsePublicThreadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesCollectionResponsePublicThreadEntity)
  self._name = "conversations_inbox_messages_collection_response_public_thread"
  self._client = client
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesCollectionResponsePublicThreadEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:match_get()
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesCollectionResponsePublicThreadListMatch
---@param ctrl? table
---@return ConversationsInboxMessagesCollectionResponsePublicThread[]
---@return string? err
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesCollectionResponsePublicThreadEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesCollectionResponsePublicThreadEntity
