...
local ConversationsPublicActorEntity = {}
ConversationsPublicActorEntity.__index = ConversationsPublicActorEntity


function ConversationsPublicActorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicActorEntity)
  self._name = "conversations_public_actor"
  self._client = client
...
function ConversationsPublicActorEntity:get_name()
  return self._name
end


function ConversationsPublicActorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicActorEntity.new(self._client, opts)
end
...
function ConversationsPublicActorEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicActorEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicActorEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicActorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicActorEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicActorEntity:match_get()
...
function ConversationsPublicActorEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicActorLoadMatch
---@param ctrl? table
---@return ConversationsPublicActor
---@return string? err
function ConversationsPublicActorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsPublicActorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicActorEntity
