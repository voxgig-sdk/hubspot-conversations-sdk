...
local ConversationsPublicChannelEntity = {}
ConversationsPublicChannelEntity.__index = ConversationsPublicChannelEntity


function ConversationsPublicChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicChannelEntity)
  self._name = "conversations_public_channel"
  self._client = client
...
function ConversationsPublicChannelEntity:get_name()
  return self._name
end


function ConversationsPublicChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicChannelEntity.new(self._client, opts)
end
...
function ConversationsPublicChannelEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicChannelEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicChannelEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicChannelEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicChannelEntity:match_get()
...
function ConversationsPublicChannelEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicChannelLoadMatch
---@param ctrl? table
---@return ConversationsPublicChannel
---@return string? err
function ConversationsPublicChannelEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsPublicChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicChannelEntity
