-- HubspotConversations SDK ConversationsPublicChannelAccount entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsPublicChannelAccountEntity = {}
ConversationsPublicChannelAccountEntity.__index = ConversationsPublicChannelAccountEntity


function ConversationsPublicChannelAccountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicChannelAccountEntity)
  self._name = "conversations_public_channel_account"
  self._client = client
...
function ConversationsPublicChannelAccountEntity:get_name()
  return self._name
end


function ConversationsPublicChannelAccountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicChannelAccountEntity.new(self._client, opts)
end
...
function ConversationsPublicChannelAccountEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicChannelAccountEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicChannelAccountEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicChannelAccountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicChannelAccountEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicChannelAccountEntity:match_get()
...
function ConversationsPublicChannelAccountEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicChannelAccountLoadMatch
---@param ctrl? table
---@return ConversationsPublicChannelAccount
---@return string? err
function ConversationsPublicChannelAccountEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsPublicChannelAccountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicChannelAccountEntity
