-- HubspotConversations SDK ConversationsCollectionResponseWithTotalPublicChannelAccount entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsCollectionResponseWithTotalPublicChannelAccountEntity = {}
ConversationsCollectionResponseWithTotalPublicChannelAccountEntity.__index = ConversationsCollectionResponseWithTotalPublicChannelAccountEntity


function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsCollectionResponseWithTotalPublicChannelAccountEntity)
  self._name = "conversations_collection_response_with_total_public_channel_account"
  self._client = client
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:get_name()
  return self._name
end


function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsCollectionResponseWithTotalPublicChannelAccountEntity.new(self._client, opts)
end
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:mark_deleted()
  self._deleted = true
end


function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:deleted()
  return true == self._deleted
end


function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:data_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:match_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:match_get()
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsCollectionResponseWithTotalPublicChannelAccountListMatch
---@param ctrl? table
---@return ConversationsCollectionResponseWithTotalPublicChannelAccount[]
---@return string? err
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsCollectionResponseWithTotalPublicChannelAccountEntity
