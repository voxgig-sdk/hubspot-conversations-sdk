...
local ConversationsInboxMessagesPublicMessageEntity = {}
ConversationsInboxMessagesPublicMessageEntity.__index = ConversationsInboxMessagesPublicMessageEntity


function ConversationsInboxMessagesPublicMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicMessageEntity)
  self._name = "conversations_inbox_messages_public_message"
  self._client = client
...
function ConversationsInboxMessagesPublicMessageEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicMessageEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicMessageEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicMessageEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicMessageEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicMessageEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicMessageEntity:match_get()
...
function ConversationsInboxMessagesPublicMessageEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicMessageLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicMessage
---@return string? err
function ConversationsInboxMessagesPublicMessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConversationsInboxMessagesPublicMessageCreateData
---@param ctrl? table
---@return ConversationsInboxMessagesPublicMessage
---@return string? err
function ConversationsInboxMessagesPublicMessageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ConversationsInboxMessagesPublicMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicMessageEntity
