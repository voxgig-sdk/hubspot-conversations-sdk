...
local ConversationsPublicThreadEntity = {}
ConversationsPublicThreadEntity.__index = ConversationsPublicThreadEntity


function ConversationsPublicThreadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicThreadEntity)
  self._name = "conversations_public_thread"
  self._client = client
...
function ConversationsPublicThreadEntity:get_name()
  return self._name
end


function ConversationsPublicThreadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicThreadEntity.new(self._client, opts)
end
...
function ConversationsPublicThreadEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicThreadEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicThreadEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicThreadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicThreadEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicThreadEntity:match_get()
...
function ConversationsPublicThreadEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicThreadLoadMatch
---@param ctrl? table
---@return ConversationsPublicThread
---@return string? err
function ConversationsPublicThreadEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConversationsPublicThreadUpdateData
---@param ctrl? table
---@return ConversationsPublicThread
---@return string? err
function ConversationsPublicThreadEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ConversationsPublicThreadRemoveMatch
---@param ctrl? table
---@return ConversationsPublicThread
---@return string? err
function ConversationsPublicThreadEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ConversationsPublicThreadEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicThreadEntity
