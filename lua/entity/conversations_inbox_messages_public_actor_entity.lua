-- HubspotConversations SDK ConversationsInboxMessagesPublicActor entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesPublicActorEntity = {}
ConversationsInboxMessagesPublicActorEntity.__index = ConversationsInboxMessagesPublicActorEntity


function ConversationsInboxMessagesPublicActorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicActorEntity)
  self._name = "conversations_inbox_messages_public_actor"
  self._client = client
...
function ConversationsInboxMessagesPublicActorEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicActorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicActorEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicActorEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicActorEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicActorEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicActorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicActorEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicActorEntity:match_get()
...
function ConversationsInboxMessagesPublicActorEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicActorLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicActor
---@return string? err
function ConversationsInboxMessagesPublicActorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesPublicActorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicActorEntity
