...
local ConversationsPublicMessageEntity = {}
ConversationsPublicMessageEntity.__index = ConversationsPublicMessageEntity


function ConversationsPublicMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicMessageEntity)
  self._name = "conversations_public_message"
  self._client = client
...
function ConversationsPublicMessageEntity:get_name()
  return self._name
end


function ConversationsPublicMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicMessageEntity.new(self._client, opts)
end
...
function ConversationsPublicMessageEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicMessageEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicMessageEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicMessageEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicMessageEntity:match_get()
...
function ConversationsPublicMessageEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicMessageLoadMatch
---@param ctrl? table
---@return ConversationsPublicMessage
---@return string? err
function ConversationsPublicMessageEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConversationsPublicMessageCreateData
---@param ctrl? table
---@return ConversationsPublicMessage
---@return string? err
function ConversationsPublicMessageEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ConversationsPublicMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicMessageEntity
