-- HubspotConversations SDK ConversationsInboxMessagesCollectionResponsePublicMessage entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesCollectionResponsePublicMessageEntity = {}
ConversationsInboxMessagesCollectionResponsePublicMessageEntity.__index = ConversationsInboxMessagesCollectionResponsePublicMessageEntity


function ConversationsInboxMessagesCollectionResponsePublicMessageEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesCollectionResponsePublicMessageEntity)
  self._name = "conversations_inbox_messages_collection_response_public_message"
  self._client = client
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesCollectionResponsePublicMessageEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:match_get()
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesCollectionResponsePublicMessageListMatch
---@param ctrl? table
---@return ConversationsInboxMessagesCollectionResponsePublicMessage[]
---@return string? err
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesCollectionResponsePublicMessageEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesCollectionResponsePublicMessageEntity
