-- HubspotConversations SDK ConversationsPublicMessageContent entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsPublicMessageContentEntity = {}
ConversationsPublicMessageContentEntity.__index = ConversationsPublicMessageContentEntity


function ConversationsPublicMessageContentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicMessageContentEntity)
  self._name = "conversations_public_message_content"
  self._client = client
...
function ConversationsPublicMessageContentEntity:get_name()
  return self._name
end


function ConversationsPublicMessageContentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicMessageContentEntity.new(self._client, opts)
end
...
function ConversationsPublicMessageContentEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicMessageContentEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicMessageContentEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicMessageContentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicMessageContentEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicMessageContentEntity:match_get()
...
function ConversationsPublicMessageContentEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicMessageContentLoadMatch
---@param ctrl? table
---@return ConversationsPublicMessageContent
---@return string? err
function ConversationsPublicMessageContentEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsPublicMessageContentEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicMessageContentEntity
