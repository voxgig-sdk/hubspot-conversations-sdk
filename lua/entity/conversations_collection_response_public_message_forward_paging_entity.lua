-- HubspotConversations SDK ConversationsCollectionResponsePublicMessageForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsCollectionResponsePublicMessageForwardPagingEntity = {}
ConversationsCollectionResponsePublicMessageForwardPagingEntity.__index = ConversationsCollectionResponsePublicMessageForwardPagingEntity


function ConversationsCollectionResponsePublicMessageForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsCollectionResponsePublicMessageForwardPagingEntity)
  self._name = "conversations_collection_response_public_message_forward_paging"
  self._client = client
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:get_name()
  return self._name
end


function ConversationsCollectionResponsePublicMessageForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsCollectionResponsePublicMessageForwardPagingEntity.new(self._client, opts)
end
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function ConversationsCollectionResponsePublicMessageForwardPagingEntity:deleted()
  return true == self._deleted
end


function ConversationsCollectionResponsePublicMessageForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsCollectionResponsePublicMessageForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:match_get()
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsCollectionResponsePublicMessageForwardPagingListMatch
---@param ctrl? table
---@return ConversationsCollectionResponsePublicMessageForwardPaging[]
---@return string? err
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsCollectionResponsePublicMessageForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsCollectionResponsePublicMessageForwardPagingEntity
