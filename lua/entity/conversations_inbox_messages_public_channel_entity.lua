-- HubspotConversations SDK ConversationsInboxMessagesPublicChannel entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesPublicChannelEntity = {}
ConversationsInboxMessagesPublicChannelEntity.__index = ConversationsInboxMessagesPublicChannelEntity


function ConversationsInboxMessagesPublicChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicChannelEntity)
  self._name = "conversations_inbox_messages_public_channel"
  self._client = client
...
function ConversationsInboxMessagesPublicChannelEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicChannelEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicChannelEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicChannelEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicChannelEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicChannelEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicChannelEntity:match_get()
...
function ConversationsInboxMessagesPublicChannelEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicChannelLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicChannel
---@return string? err
function ConversationsInboxMessagesPublicChannelEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesPublicChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicChannelEntity
