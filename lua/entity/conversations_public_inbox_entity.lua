...
local ConversationsPublicInboxEntity = {}
ConversationsPublicInboxEntity.__index = ConversationsPublicInboxEntity


function ConversationsPublicInboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsPublicInboxEntity)
  self._name = "conversations_public_inbox"
  self._client = client
...
function ConversationsPublicInboxEntity:get_name()
  return self._name
end


function ConversationsPublicInboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsPublicInboxEntity.new(self._client, opts)
end
...
function ConversationsPublicInboxEntity:mark_deleted()
  self._deleted = true
end


function ConversationsPublicInboxEntity:deleted()
  return true == self._deleted
end


function ConversationsPublicInboxEntity:data_set(args)
  if args ~= nil then
...
function ConversationsPublicInboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsPublicInboxEntity:match_set(args)
  if args ~= nil then
...
function ConversationsPublicInboxEntity:match_get()
...
function ConversationsPublicInboxEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsPublicInboxLoadMatch
---@param ctrl? table
---@return ConversationsPublicInbox
---@return string? err
function ConversationsPublicInboxEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsPublicInboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsPublicInboxEntity
