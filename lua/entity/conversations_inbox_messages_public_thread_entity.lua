...
local ConversationsInboxMessagesPublicThreadEntity = {}
ConversationsInboxMessagesPublicThreadEntity.__index = ConversationsInboxMessagesPublicThreadEntity


function ConversationsInboxMessagesPublicThreadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicThreadEntity)
  self._name = "conversations_inbox_messages_public_thread"
  self._client = client
...
function ConversationsInboxMessagesPublicThreadEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicThreadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicThreadEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicThreadEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicThreadEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicThreadEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicThreadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicThreadEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicThreadEntity:match_get()
...
function ConversationsInboxMessagesPublicThreadEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicThreadLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicThread
---@return string? err
function ConversationsInboxMessagesPublicThreadEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConversationsInboxMessagesPublicThreadUpdateData
---@param ctrl? table
---@return ConversationsInboxMessagesPublicThread
---@return string? err
function ConversationsInboxMessagesPublicThreadEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ConversationsInboxMessagesPublicThreadEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicThreadEntity
