-- HubspotConversations SDK ConversationsInboxMessagesCollectionResponseWithTotalPublic3 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity = {}
ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity.__index = ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity


function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity)
  self._name = "conversations_inbox_messages_collection_response_with_total_public3"
  self._client = client
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:get_name()
  return self._name
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity.new(self._client, opts)
end
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:match_get()
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesCollectionResponseWithTotalPublic3ListMatch
---@param ctrl? table
---@return ConversationsInboxMessagesCollectionResponseWithTotalPublic3[]
---@return string? err
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesCollectionResponseWithTotalPublic3Entity
