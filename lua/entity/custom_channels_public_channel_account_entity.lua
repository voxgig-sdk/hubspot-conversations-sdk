...
local CustomChannelsPublicChannelAccountEntity = {}
CustomChannelsPublicChannelAccountEntity.__index = CustomChannelsPublicChannelAccountEntity


function CustomChannelsPublicChannelAccountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsPublicChannelAccountEntity)
  self._name = "custom_channels_public_channel_account"
  self._client = client
...
function CustomChannelsPublicChannelAccountEntity:get_name()
  return self._name
end


function CustomChannelsPublicChannelAccountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsPublicChannelAccountEntity.new(self._client, opts)
end
...
function CustomChannelsPublicChannelAccountEntity:mark_deleted()
  self._deleted = true
end


function CustomChannelsPublicChannelAccountEntity:deleted()
  return true == self._deleted
end


function CustomChannelsPublicChannelAccountEntity:data_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelAccountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsPublicChannelAccountEntity:match_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelAccountEntity:match_get()
...
function CustomChannelsPublicChannelAccountEntity:stream(action, args, callopts)
...
---@param reqmatch CustomChannelsPublicChannelAccountLoadMatch
---@param ctrl? table
---@return CustomChannelsPublicChannelAccount
---@return string? err
function CustomChannelsPublicChannelAccountEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CustomChannelsPublicChannelAccountCreateData
---@param ctrl? table
---@return CustomChannelsPublicChannelAccount
---@return string? err
function CustomChannelsPublicChannelAccountEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CustomChannelsPublicChannelAccountUpdateData
---@param ctrl? table
---@return CustomChannelsPublicChannelAccount
---@return string? err
function CustomChannelsPublicChannelAccountEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CustomChannelsPublicChannelAccountEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsPublicChannelAccountEntity
