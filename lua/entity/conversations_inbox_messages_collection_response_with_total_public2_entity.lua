-- HubspotConversations SDK ConversationsInboxMessagesCollectionResponseWithTotalPublic2 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity = {}
ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity.__index = ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity


function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity)
  self._name = "conversations_inbox_messages_collection_response_with_total_public2"
  self._client = client
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:get_name()
  return self._name
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity.new(self._client, opts)
end
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:match_get()
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesCollectionResponseWithTotalPublic2ListMatch
---@param ctrl? table
---@return ConversationsInboxMessagesCollectionResponseWithTotalPublic2[]
---@return string? err
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity
