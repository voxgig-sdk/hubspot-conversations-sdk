-- HubspotConversations SDK ConversationsInboxMessagesBatchResponsePublicActor entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesBatchResponsePublicActorEntity = {}
ConversationsInboxMessagesBatchResponsePublicActorEntity.__index = ConversationsInboxMessagesBatchResponsePublicActorEntity


function ConversationsInboxMessagesBatchResponsePublicActorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesBatchResponsePublicActorEntity)
  self._name = "conversations_inbox_messages_batch_response_public_actor"
  self._client = client
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesBatchResponsePublicActorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesBatchResponsePublicActorEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesBatchResponsePublicActorEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesBatchResponsePublicActorEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesBatchResponsePublicActorEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:match_get()
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:stream(action, args, callopts)
...
---@param reqdata ConversationsInboxMessagesBatchResponsePublicActorCreateData
---@param ctrl? table
---@return ConversationsInboxMessagesBatchResponsePublicActor
---@return string? err
function ConversationsInboxMessagesBatchResponsePublicActorEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesBatchResponsePublicActorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesBatchResponsePublicActorEntity
