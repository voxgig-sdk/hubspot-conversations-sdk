-- HubspotConversations SDK CustomChannelsPublicChannelAccountStagingToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CustomChannelsPublicChannelAccountStagingTokenEntity = {}
CustomChannelsPublicChannelAccountStagingTokenEntity.__index = CustomChannelsPublicChannelAccountStagingTokenEntity


function CustomChannelsPublicChannelAccountStagingTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsPublicChannelAccountStagingTokenEntity)
  self._name = "custom_channels_public_channel_account_staging_token"
  self._client = client
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:get_name()
  return self._name
end


function CustomChannelsPublicChannelAccountStagingTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsPublicChannelAccountStagingTokenEntity.new(self._client, opts)
end
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:mark_deleted()
  self._deleted = true
end


function CustomChannelsPublicChannelAccountStagingTokenEntity:deleted()
  return true == self._deleted
end


function CustomChannelsPublicChannelAccountStagingTokenEntity:data_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsPublicChannelAccountStagingTokenEntity:match_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:match_get()
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:stream(action, args, callopts)
...
---@param reqdata CustomChannelsPublicChannelAccountStagingTokenUpdateData
---@param ctrl? table
---@return CustomChannelsPublicChannelAccountStagingToken
---@return string? err
function CustomChannelsPublicChannelAccountStagingTokenEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function CustomChannelsPublicChannelAccountStagingTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsPublicChannelAccountStagingTokenEntity
