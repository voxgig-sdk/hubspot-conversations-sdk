-- HubspotConversations SDK CustomChannelsCollectionResponseWithTotalPublicChannel2 entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CustomChannelsCollectionResponseWithTotalPublicChannel2Entity = {}
CustomChannelsCollectionResponseWithTotalPublicChannel2Entity.__index = CustomChannelsCollectionResponseWithTotalPublicChannel2Entity


function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsCollectionResponseWithTotalPublicChannel2Entity)
  self._name = "custom_channels_collection_response_with_total_public_channel2"
  self._client = client
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:get_name()
  return self._name
end


function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsCollectionResponseWithTotalPublicChannel2Entity.new(self._client, opts)
end
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:mark_deleted()
  self._deleted = true
end


function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:deleted()
  return true == self._deleted
end


function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:data_set(args)
  if args ~= nil then
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:match_set(args)
  if args ~= nil then
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:match_get()
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:stream(action, args, callopts)
...
---@param reqmatch CustomChannelsCollectionResponseWithTotalPublicChannel2ListMatch
---@param ctrl? table
---@return CustomChannelsCollectionResponseWithTotalPublicChannel2[]
---@return string? err
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CustomChannelsCollectionResponseWithTotalPublicChannel2Entity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsCollectionResponseWithTotalPublicChannel2Entity
