-- HubspotConversations SDK VisitorIdentificationIdentificationToken entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local VisitorIdentificationIdentificationTokenEntity = {}
VisitorIdentificationIdentificationTokenEntity.__index = VisitorIdentificationIdentificationTokenEntity


function VisitorIdentificationIdentificationTokenEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VisitorIdentificationIdentificationTokenEntity)
  self._name = "visitor_identification_identification_token"
  self._client = client
...
function VisitorIdentificationIdentificationTokenEntity:get_name()
  return self._name
end


function VisitorIdentificationIdentificationTokenEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VisitorIdentificationIdentificationTokenEntity.new(self._client, opts)
end
...
function VisitorIdentificationIdentificationTokenEntity:mark_deleted()
  self._deleted = true
end


function VisitorIdentificationIdentificationTokenEntity:deleted()
  return true == self._deleted
end


function VisitorIdentificationIdentificationTokenEntity:data_set(args)
  if args ~= nil then
...
function VisitorIdentificationIdentificationTokenEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VisitorIdentificationIdentificationTokenEntity:match_set(args)
  if args ~= nil then
...
function VisitorIdentificationIdentificationTokenEntity:match_get()
...
function VisitorIdentificationIdentificationTokenEntity:stream(action, args, callopts)
...
---@param reqdata VisitorIdentificationIdentificationTokenCreateData
---@param ctrl? table
---@return VisitorIdentificationIdentificationToken
---@return string? err
function VisitorIdentificationIdentificationTokenEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function VisitorIdentificationIdentificationTokenEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return VisitorIdentificationIdentificationTokenEntity
