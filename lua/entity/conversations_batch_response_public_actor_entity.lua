-- HubspotConversations SDK ConversationsBatchResponsePublicActor entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsBatchResponsePublicActorEntity = {}
ConversationsBatchResponsePublicActorEntity.__index = ConversationsBatchResponsePublicActorEntity


function ConversationsBatchResponsePublicActorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsBatchResponsePublicActorEntity)
  self._name = "conversations_batch_response_public_actor"
  self._client = client
...
function ConversationsBatchResponsePublicActorEntity:get_name()
  return self._name
end


function ConversationsBatchResponsePublicActorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsBatchResponsePublicActorEntity.new(self._client, opts)
end
...
function ConversationsBatchResponsePublicActorEntity:mark_deleted()
  self._deleted = true
end


function ConversationsBatchResponsePublicActorEntity:deleted()
  return true == self._deleted
end


function ConversationsBatchResponsePublicActorEntity:data_set(args)
  if args ~= nil then
...
function ConversationsBatchResponsePublicActorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsBatchResponsePublicActorEntity:match_set(args)
  if args ~= nil then
...
function ConversationsBatchResponsePublicActorEntity:match_get()
...
function ConversationsBatchResponsePublicActorEntity:stream(action, args, callopts)
...
---@param reqdata ConversationsBatchResponsePublicActorCreateData
---@param ctrl? table
---@return ConversationsBatchResponsePublicActor
---@return string? err
function ConversationsBatchResponsePublicActorEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ConversationsBatchResponsePublicActorEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsBatchResponsePublicActorEntity
