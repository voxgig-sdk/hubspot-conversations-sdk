-- HubspotConversations SDK ConversationsCollectionResponseWithTotalPublicInbox entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsCollectionResponseWithTotalPublicInboxEntity = {}
ConversationsCollectionResponseWithTotalPublicInboxEntity.__index = ConversationsCollectionResponseWithTotalPublicInboxEntity


function ConversationsCollectionResponseWithTotalPublicInboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsCollectionResponseWithTotalPublicInboxEntity)
  self._name = "conversations_collection_response_with_total_public_inbox"
  self._client = client
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:get_name()
  return self._name
end


function ConversationsCollectionResponseWithTotalPublicInboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsCollectionResponseWithTotalPublicInboxEntity.new(self._client, opts)
end
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:mark_deleted()
  self._deleted = true
end


function ConversationsCollectionResponseWithTotalPublicInboxEntity:deleted()
  return true == self._deleted
end


function ConversationsCollectionResponseWithTotalPublicInboxEntity:data_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsCollectionResponseWithTotalPublicInboxEntity:match_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:match_get()
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsCollectionResponseWithTotalPublicInboxListMatch
---@param ctrl? table
---@return ConversationsCollectionResponseWithTotalPublicInbox[]
---@return string? err
function ConversationsCollectionResponseWithTotalPublicInboxEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsCollectionResponseWithTotalPublicInboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsCollectionResponseWithTotalPublicInboxEntity
