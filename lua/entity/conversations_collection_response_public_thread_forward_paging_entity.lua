-- HubspotConversations SDK ConversationsCollectionResponsePublicThreadForwardPaging entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsCollectionResponsePublicThreadForwardPagingEntity = {}
ConversationsCollectionResponsePublicThreadForwardPagingEntity.__index = ConversationsCollectionResponsePublicThreadForwardPagingEntity


function ConversationsCollectionResponsePublicThreadForwardPagingEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsCollectionResponsePublicThreadForwardPagingEntity)
  self._name = "conversations_collection_response_public_thread_forward_paging"
  self._client = client
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:get_name()
  return self._name
end


function ConversationsCollectionResponsePublicThreadForwardPagingEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsCollectionResponsePublicThreadForwardPagingEntity.new(self._client, opts)
end
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:mark_deleted()
  self._deleted = true
end


function ConversationsCollectionResponsePublicThreadForwardPagingEntity:deleted()
  return true == self._deleted
end


function ConversationsCollectionResponsePublicThreadForwardPagingEntity:data_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsCollectionResponsePublicThreadForwardPagingEntity:match_set(args)
  if args ~= nil then
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:match_get()
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsCollectionResponsePublicThreadForwardPagingListMatch
---@param ctrl? table
---@return ConversationsCollectionResponsePublicThreadForwardPaging[]
---@return string? err
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsCollectionResponsePublicThreadForwardPagingEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsCollectionResponsePublicThreadForwardPagingEntity
