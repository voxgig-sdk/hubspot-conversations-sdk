-- HubspotConversations SDK CustomChannelsCollectionResponseWithTotalPublicChannel entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local CustomChannelsCollectionResponseWithTotalPublicChannelEntity = {}
CustomChannelsCollectionResponseWithTotalPublicChannelEntity.__index = CustomChannelsCollectionResponseWithTotalPublicChannelEntity


function CustomChannelsCollectionResponseWithTotalPublicChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsCollectionResponseWithTotalPublicChannelEntity)
  self._name = "custom_channels_collection_response_with_total_public_channel"
  self._client = client
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:get_name()
  return self._name
end


function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsCollectionResponseWithTotalPublicChannelEntity.new(self._client, opts)
end
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:mark_deleted()
  self._deleted = true
end


function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:deleted()
  return true == self._deleted
end


function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:data_set(args)
  if args ~= nil then
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:match_set(args)
  if args ~= nil then
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:match_get()
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:stream(action, args, callopts)
...
---@param reqmatch CustomChannelsCollectionResponseWithTotalPublicChannelListMatch
---@param ctrl? table
---@return CustomChannelsCollectionResponseWithTotalPublicChannel[]
---@return string? err
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CustomChannelsCollectionResponseWithTotalPublicChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsCollectionResponseWithTotalPublicChannelEntity
