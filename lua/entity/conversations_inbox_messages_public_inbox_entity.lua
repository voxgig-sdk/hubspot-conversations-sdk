-- HubspotConversations SDK ConversationsInboxMessagesPublicInbox entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConversationsInboxMessagesPublicInboxEntity = {}
ConversationsInboxMessagesPublicInboxEntity.__index = ConversationsInboxMessagesPublicInboxEntity


function ConversationsInboxMessagesPublicInboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationsInboxMessagesPublicInboxEntity)
  self._name = "conversations_inbox_messages_public_inbox"
  self._client = client
...
function ConversationsInboxMessagesPublicInboxEntity:get_name()
  return self._name
end


function ConversationsInboxMessagesPublicInboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationsInboxMessagesPublicInboxEntity.new(self._client, opts)
end
...
function ConversationsInboxMessagesPublicInboxEntity:mark_deleted()
  self._deleted = true
end


function ConversationsInboxMessagesPublicInboxEntity:deleted()
  return true == self._deleted
end


function ConversationsInboxMessagesPublicInboxEntity:data_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicInboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationsInboxMessagesPublicInboxEntity:match_set(args)
  if args ~= nil then
...
function ConversationsInboxMessagesPublicInboxEntity:match_get()
...
function ConversationsInboxMessagesPublicInboxEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationsInboxMessagesPublicInboxLoadMatch
---@param ctrl? table
---@return ConversationsInboxMessagesPublicInbox
---@return string? err
function ConversationsInboxMessagesPublicInboxEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ConversationsInboxMessagesPublicInboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConversationsInboxMessagesPublicInboxEntity
