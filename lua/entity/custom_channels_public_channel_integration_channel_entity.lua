...
local CustomChannelsPublicChannelIntegrationChannelEntity = {}
CustomChannelsPublicChannelIntegrationChannelEntity.__index = CustomChannelsPublicChannelIntegrationChannelEntity


function CustomChannelsPublicChannelIntegrationChannelEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CustomChannelsPublicChannelIntegrationChannelEntity)
  self._name = "custom_channels_public_channel_integration_channel"
  self._client = client
...
function CustomChannelsPublicChannelIntegrationChannelEntity:get_name()
  return self._name
end


function CustomChannelsPublicChannelIntegrationChannelEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CustomChannelsPublicChannelIntegrationChannelEntity.new(self._client, opts)
end
...
function CustomChannelsPublicChannelIntegrationChannelEntity:mark_deleted()
  self._deleted = true
end


function CustomChannelsPublicChannelIntegrationChannelEntity:deleted()
  return true == self._deleted
end


function CustomChannelsPublicChannelIntegrationChannelEntity:data_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelIntegrationChannelEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CustomChannelsPublicChannelIntegrationChannelEntity:match_set(args)
  if args ~= nil then
...
function CustomChannelsPublicChannelIntegrationChannelEntity:match_get()
...
function CustomChannelsPublicChannelIntegrationChannelEntity:stream(action, args, callopts)
...
---@param reqmatch CustomChannelsPublicChannelIntegrationChannelLoadMatch
---@param ctrl? table
---@return CustomChannelsPublicChannelIntegrationChannel
---@return string? err
function CustomChannelsPublicChannelIntegrationChannelEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CustomChannelsPublicChannelIntegrationChannelCreateData
---@param ctrl? table
---@return CustomChannelsPublicChannelIntegrationChannel
---@return string? err
function CustomChannelsPublicChannelIntegrationChannelEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CustomChannelsPublicChannelIntegrationChannelUpdateData
---@param ctrl? table
---@return CustomChannelsPublicChannelIntegrationChannel
---@return string? err
function CustomChannelsPublicChannelIntegrationChannelEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function CustomChannelsPublicChannelIntegrationChannelEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CustomChannelsPublicChannelIntegrationChannelEntity
