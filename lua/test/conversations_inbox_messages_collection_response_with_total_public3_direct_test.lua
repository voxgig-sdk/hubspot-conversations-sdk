...
describe("ConversationsInboxMessagesCollectionResponseWithTotalPublic3Direct", function()
  it("should direct-list-conversations_inbox_messages_collection_response_with_total_public3", function()
    local setup = conversations_inbox_messages_collection_response_with_total_public3_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-conversations_inbox_messages_collection_response_with_total_public3", setup.live and "live" or "unit")
...
function conversations_inbox_messages_collection_response_with_total_public3_direct_setup(mockres)
