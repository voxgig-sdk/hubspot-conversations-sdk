...
describe("ConversationsInboxMessagesPublicThreadDirect", function()
  it("should direct-load-conversations_inbox_messages_public_thread", function()
    local setup = conversations_inbox_messages_public_thread_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversations_inbox_messages_public_thread", setup.live and "live" or "unit")
...
function conversations_inbox_messages_public_thread_direct_setup(mockres)
