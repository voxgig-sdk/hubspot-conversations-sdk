...
describe("CustomChannelsCollectionResponseWithTotalPublicChannelDirect", function()
  it("should direct-list-custom_channels_collection_response_with_total_public_channel", function()
    local setup = custom_channels_collection_response_with_total_public_channel_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-custom_channels_collection_response_with_total_public_channel", setup.live and "live" or "unit")
