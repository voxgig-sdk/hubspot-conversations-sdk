...
describe("ConversationsPublicInboxDirect", function()
  it("should direct-load-conversations_public_inbox", function()
    local setup = conversations_public_inbox_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-conversations_public_inbox", setup.live and "live" or "unit")
...
function conversations_public_inbox_direct_setup(mockres)
