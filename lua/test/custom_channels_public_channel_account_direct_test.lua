...
describe("CustomChannelsPublicChannelAccountDirect", function()
  it("should direct-load-custom_channels_public_channel_account", function()
    local setup = custom_channels_public_channel_account_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-custom_channels_public_channel_account", setup.live and "live" or "unit")
...
function custom_channels_public_channel_account_direct_setup(mockres)
