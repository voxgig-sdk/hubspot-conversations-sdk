...
describe("ConversationsCollectionResponseWithTotalPublicInboxDirect", function()
  it("should direct-list-conversations_collection_response_with_total_public_inbox", function()
    local setup = conversations_collection_response_with_total_public_inbox_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-conversations_collection_response_with_total_public_inbox", setup.live and "live" or "unit")
...
function conversations_collection_response_with_total_public_inbox_direct_setup(mockres)
