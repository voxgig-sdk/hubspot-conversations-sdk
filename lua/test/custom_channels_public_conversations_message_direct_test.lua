...
describe("CustomChannelsPublicConversationsMessageDirect", function()
  it("should direct-load-custom_channels_public_conversations_message", function()
    local setup = custom_channels_public_conversations_message_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-custom_channels_public_conversations_message", setup.live and "live" or "unit")
...
function custom_channels_public_conversations_message_direct_setup(mockres)
