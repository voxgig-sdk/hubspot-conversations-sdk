# HubspotConversations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HubspotConversationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HubspotConversationsSDK(...) and HubspotConversationsSDK.test(...) become
#      HubspotConversationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hubspotconversations_sdk"
_SDK_CLASS = "HubspotConversationsSDK"
...
_ENTITIES = {
    "Channel": "channel",
    "ConversationsBatchResponsePublicActor": "conversations_batch_response_public_actor",
    "ConversationsCollectionResponsePublicMessageForwardPaging": "conversations_collection_response_public_message_forward_paging",
    "ConversationsCollectionResponsePublicThreadForwardPaging": "conversations_collection_response_public_thread_forward_paging",
    "ConversationsCollectionResponseWithTotalPublicChannel": "conversations_collection_response_with_total_public_channel",
    "ConversationsCollectionResponseWithTotalPublicChannelAccount": "conversations_collection_response_with_total_public_channel_account",
    "ConversationsCollectionResponseWithTotalPublicInbox": "conversations_collection_response_with_total_public_inbox",
    "ConversationsInboxMessagesBatchResponsePublicActor": "conversations_inbox_messages_batch_response_public_actor",
    "ConversationsInboxMessagesCollectionResponsePublicMessage": "conversations_inbox_messages_collection_response_public_message",
    "ConversationsInboxMessagesCollectionResponsePublicThread": "conversations_inbox_messages_collection_response_public_thread",
    "ConversationsInboxMessagesCollectionResponseWithTotalPublic": "conversations_inbox_messages_collection_response_with_total_public",
    "ConversationsInboxMessagesCollectionResponseWithTotalPublic2": "conversations_inbox_messages_collection_response_with_total_public2",
    "ConversationsInboxMessagesCollectionResponseWithTotalPublic3": "conversations_inbox_messages_collection_response_with_total_public3",
    "ConversationsInboxMessagesPublicActor": "conversations_inbox_messages_public_actor",
    "ConversationsInboxMessagesPublicChannel": "conversations_inbox_messages_public_channel",
    "ConversationsInboxMessagesPublicChannelAccount": "conversations_inbox_messages_public_channel_account",
    "ConversationsInboxMessagesPublicInbox": "conversations_inbox_messages_public_inbox",
    "ConversationsInboxMessagesPublicMessage": "conversations_inbox_messages_public_message",
    "ConversationsInboxMessagesPublicMessageContent": "conversations_inbox_messages_public_message_content",
    "ConversationsInboxMessagesPublicThread": "conversations_inbox_messages_public_thread",
    "ConversationsPublicActor": "conversations_public_actor",
    "ConversationsPublicChannel": "conversations_public_channel",
    "ConversationsPublicChannelAccount": "conversations_public_channel_account",
    "ConversationsPublicInbox": "conversations_public_inbox",
    "ConversationsPublicMessage": "conversations_public_message",
    "ConversationsPublicMessageContent": "conversations_public_message_content",
    "ConversationsPublicThread": "conversations_public_thread",
    "CustomChannelsCollectionResponseWithTotalPublicChannel": "custom_channels_collection_response_with_total_public_channel",
    "CustomChannelsCollectionResponseWithTotalPublicChannel2": "custom_channels_collection_response_with_total_public_channel2",
    "CustomChannelsPublicChannelAccount": "custom_channels_public_channel_account",
    "CustomChannelsPublicChannelAccountStagingToken": "custom_channels_public_channel_account_staging_token",
    "CustomChannelsPublicChannelIntegrationChannel": "custom_channels_public_channel_integration_channel",
    "CustomChannelsPublicConversationsMessage": "custom_channels_public_conversations_message",
    "PublicThread": "public_thread",
    "Thread": "thread",
    "VisitorIdentificationIdentificationToken": "visitor_identification_identification_token",
}
