...
class CustomChannelsPublicChannelAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomChannelsPublicChannelAccountEntity(self._client, opts)
    ...
    def data_get(self) -> CustomChannelsPublicChannelAccount:
    ...
    def match_get(self) -> CustomChannelsPublicChannelAccount:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CustomChannelsPublicChannelAccount:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CustomChannelsPublicChannelAccount().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CustomChannelsPublicChannelAccountCreateData, ctrl=None) -> CustomChannelsPublicChannelAccount:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: CustomChannelsPublicChannelAccountUpdateData, ctrl=None) -> CustomChannelsPublicChannelAccount:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
