...
class ConversationsCollectionResponseWithTotalPublicChannelAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsCollectionResponseWithTotalPublicChannelAccountEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsCollectionResponseWithTotalPublicChannelAccount:
    ...
    def match_get(self) -> ConversationsCollectionResponseWithTotalPublicChannelAccount:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsCollectionResponseWithTotalPublicChannelAccount]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsCollectionResponseWithTotalPublicChannelAccount().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
