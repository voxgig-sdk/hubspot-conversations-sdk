...
class ConversationsInboxMessagesCollectionResponsePublicMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesCollectionResponsePublicMessageEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesCollectionResponsePublicMessage:
    ...
    def match_get(self) -> ConversationsInboxMessagesCollectionResponsePublicMessage:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsInboxMessagesCollectionResponsePublicMessage]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsInboxMessagesCollectionResponsePublicMessage().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
