...
class ConversationsPublicInboxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicInboxEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicInbox:
    ...
    def match_get(self) -> ConversationsPublicInbox:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicInbox:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicInbox().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
