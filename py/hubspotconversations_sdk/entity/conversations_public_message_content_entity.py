...
class ConversationsPublicMessageContentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicMessageContentEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicMessageContent:
    ...
    def match_get(self) -> ConversationsPublicMessageContent:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicMessageContent:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicMessageContent().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
