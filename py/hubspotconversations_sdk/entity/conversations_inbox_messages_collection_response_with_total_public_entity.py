...
class ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesCollectionResponseWithTotalPublicEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesCollectionResponseWithTotalPublic:
    ...
    def match_get(self) -> ConversationsInboxMessagesCollectionResponseWithTotalPublic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsInboxMessagesCollectionResponseWithTotalPublic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsInboxMessagesCollectionResponseWithTotalPublic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
