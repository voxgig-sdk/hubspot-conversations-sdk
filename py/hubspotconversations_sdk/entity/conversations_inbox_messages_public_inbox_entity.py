...
class ConversationsInboxMessagesPublicInboxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicInboxEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicInbox:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicInbox:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicInbox:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicInbox().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
