...
class ConversationsPublicChannelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicChannelEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicChannel:
    ...
    def match_get(self) -> ConversationsPublicChannel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicChannel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicChannel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
