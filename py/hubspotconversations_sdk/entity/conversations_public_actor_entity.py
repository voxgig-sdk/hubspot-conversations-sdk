...
class ConversationsPublicActorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicActorEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicActor:
    ...
    def match_get(self) -> ConversationsPublicActor:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicActor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicActor().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
