...
class ConversationsPublicMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicMessageEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicMessage:
    ...
    def match_get(self) -> ConversationsPublicMessage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicMessage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicMessage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ConversationsPublicMessageCreateData, ctrl=None) -> ConversationsPublicMessage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
