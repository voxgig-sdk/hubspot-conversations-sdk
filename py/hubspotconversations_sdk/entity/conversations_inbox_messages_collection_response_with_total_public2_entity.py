...
class ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesCollectionResponseWithTotalPublic2Entity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesCollectionResponseWithTotalPublic2:
    ...
    def match_get(self) -> ConversationsInboxMessagesCollectionResponseWithTotalPublic2:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsInboxMessagesCollectionResponseWithTotalPublic2]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsInboxMessagesCollectionResponseWithTotalPublic2().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
