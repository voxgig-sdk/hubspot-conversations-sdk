...
class CustomChannelsPublicChannelAccountStagingTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomChannelsPublicChannelAccountStagingTokenEntity(self._client, opts)
    ...
    def data_get(self) -> CustomChannelsPublicChannelAccountStagingToken:
    ...
    def match_get(self) -> CustomChannelsPublicChannelAccountStagingToken:
    ...
    def update(self, reqdata: CustomChannelsPublicChannelAccountStagingTokenUpdateData, ctrl=None) -> CustomChannelsPublicChannelAccountStagingToken:
        utility = self._utility
