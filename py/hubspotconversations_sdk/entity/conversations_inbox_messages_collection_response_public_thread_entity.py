...
class ConversationsInboxMessagesCollectionResponsePublicThreadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesCollectionResponsePublicThreadEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesCollectionResponsePublicThread:
    ...
    def match_get(self) -> ConversationsInboxMessagesCollectionResponsePublicThread:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsInboxMessagesCollectionResponsePublicThread]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsInboxMessagesCollectionResponsePublicThread().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
