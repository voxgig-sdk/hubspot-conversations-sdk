...
class ConversationsCollectionResponsePublicThreadForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsCollectionResponsePublicThreadForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsCollectionResponsePublicThreadForwardPaging:
    ...
    def match_get(self) -> ConversationsCollectionResponsePublicThreadForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsCollectionResponsePublicThreadForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsCollectionResponsePublicThreadForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
