...
class VisitorIdentificationIdentificationTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VisitorIdentificationIdentificationTokenEntity(self._client, opts)
    ...
    def data_get(self) -> VisitorIdentificationIdentificationToken:
    ...
    def match_get(self) -> VisitorIdentificationIdentificationToken:
    ...
    def create(self, reqdata: VisitorIdentificationIdentificationTokenCreateData, ctrl=None) -> VisitorIdentificationIdentificationToken:
        utility = self._utility
