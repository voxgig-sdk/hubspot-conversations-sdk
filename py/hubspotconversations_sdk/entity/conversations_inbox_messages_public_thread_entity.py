...
class ConversationsInboxMessagesPublicThreadEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicThreadEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicThread:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicThread:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicThread:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicThread().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ConversationsInboxMessagesPublicThreadUpdateData, ctrl=None) -> ConversationsInboxMessagesPublicThread:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
