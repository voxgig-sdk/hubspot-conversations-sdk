...
class CustomChannelsPublicConversationsMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomChannelsPublicConversationsMessageEntity(self._client, opts)
    ...
    def data_get(self) -> CustomChannelsPublicConversationsMessage:
    ...
    def match_get(self) -> CustomChannelsPublicConversationsMessage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CustomChannelsPublicConversationsMessage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CustomChannelsPublicConversationsMessage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CustomChannelsPublicConversationsMessageCreateData, ctrl=None) -> CustomChannelsPublicConversationsMessage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: CustomChannelsPublicConversationsMessageUpdateData, ctrl=None) -> CustomChannelsPublicConversationsMessage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
