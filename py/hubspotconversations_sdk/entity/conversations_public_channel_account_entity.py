...
class ConversationsPublicChannelAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsPublicChannelAccountEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsPublicChannelAccount:
    ...
    def match_get(self) -> ConversationsPublicChannelAccount:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsPublicChannelAccount:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsPublicChannelAccount().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
