...
class ConversationsInboxMessagesPublicMessageContentEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicMessageContentEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicMessageContent:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicMessageContent:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicMessageContent:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicMessageContent().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
