...
class CustomChannelsCollectionResponseWithTotalPublicChannelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomChannelsCollectionResponseWithTotalPublicChannelEntity(self._client, opts)
    ...
    def data_get(self) -> CustomChannelsCollectionResponseWithTotalPublicChannel:
    ...
    def match_get(self) -> CustomChannelsCollectionResponseWithTotalPublicChannel:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CustomChannelsCollectionResponseWithTotalPublicChannel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CustomChannelsCollectionResponseWithTotalPublicChannel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
