...
class ConversationsCollectionResponseWithTotalPublicInboxEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsCollectionResponseWithTotalPublicInboxEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsCollectionResponseWithTotalPublicInbox:
    ...
    def match_get(self) -> ConversationsCollectionResponseWithTotalPublicInbox:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsCollectionResponseWithTotalPublicInbox]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsCollectionResponseWithTotalPublicInbox().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
