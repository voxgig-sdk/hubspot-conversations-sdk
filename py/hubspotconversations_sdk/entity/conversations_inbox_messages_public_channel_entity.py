...
class ConversationsInboxMessagesPublicChannelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicChannelEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicChannel:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicChannel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicChannel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicChannel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
