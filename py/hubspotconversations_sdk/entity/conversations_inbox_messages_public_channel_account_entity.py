...
class ConversationsInboxMessagesPublicChannelAccountEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicChannelAccountEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicChannelAccount:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicChannelAccount:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicChannelAccount:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicChannelAccount().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
