...
class ConversationsInboxMessagesBatchResponsePublicActorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesBatchResponsePublicActorEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesBatchResponsePublicActor:
    ...
    def match_get(self) -> ConversationsInboxMessagesBatchResponsePublicActor:
    ...
    def create(self, reqdata: ConversationsInboxMessagesBatchResponsePublicActorCreateData, ctrl=None) -> ConversationsInboxMessagesBatchResponsePublicActor:
        utility = self._utility
