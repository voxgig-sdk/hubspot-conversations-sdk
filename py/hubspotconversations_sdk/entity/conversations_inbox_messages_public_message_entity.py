...
class ConversationsInboxMessagesPublicMessageEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicMessageEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicMessage:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicMessage:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicMessage:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicMessage().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ConversationsInboxMessagesPublicMessageCreateData, ctrl=None) -> ConversationsInboxMessagesPublicMessage:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
