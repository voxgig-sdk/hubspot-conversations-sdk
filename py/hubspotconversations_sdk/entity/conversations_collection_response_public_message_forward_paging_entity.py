...
class ConversationsCollectionResponsePublicMessageForwardPagingEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsCollectionResponsePublicMessageForwardPagingEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsCollectionResponsePublicMessageForwardPaging:
    ...
    def match_get(self) -> ConversationsCollectionResponsePublicMessageForwardPaging:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsCollectionResponsePublicMessageForwardPaging]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsCollectionResponsePublicMessageForwardPaging().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
