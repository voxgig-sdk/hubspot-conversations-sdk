...
class ConversationsInboxMessagesPublicActorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsInboxMessagesPublicActorEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsInboxMessagesPublicActor:
    ...
    def match_get(self) -> ConversationsInboxMessagesPublicActor:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConversationsInboxMessagesPublicActor:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConversationsInboxMessagesPublicActor().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
