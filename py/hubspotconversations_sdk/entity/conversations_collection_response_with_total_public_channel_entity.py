...
class ConversationsCollectionResponseWithTotalPublicChannelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsCollectionResponseWithTotalPublicChannelEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsCollectionResponseWithTotalPublicChannel:
    ...
    def match_get(self) -> ConversationsCollectionResponseWithTotalPublicChannel:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConversationsCollectionResponseWithTotalPublicChannel]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConversationsCollectionResponseWithTotalPublicChannel().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
