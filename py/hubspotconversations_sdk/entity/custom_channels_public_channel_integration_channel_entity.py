...
from hubspotconversations_sdk.hubspotconversations_types import (
...
class CustomChannelsPublicChannelIntegrationChannelEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CustomChannelsPublicChannelIntegrationChannelEntity(self._client, opts)
    ...
    def data_get(self) -> CustomChannelsPublicChannelIntegrationChannel:
    ...
    def match_get(self) -> CustomChannelsPublicChannelIntegrationChannel:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CustomChannelsPublicChannelIntegrationChannel:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CustomChannelsPublicChannelIntegrationChannel().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CustomChannelsPublicChannelIntegrationChannelCreateData, ctrl=None) -> CustomChannelsPublicChannelIntegrationChannel:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: CustomChannelsPublicChannelIntegrationChannelUpdateData, ctrl=None) -> CustomChannelsPublicChannelIntegrationChannel:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
