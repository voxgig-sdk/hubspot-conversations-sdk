...
class ConversationsBatchResponsePublicActorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConversationsBatchResponsePublicActorEntity(self._client, opts)
    ...
    def data_get(self) -> ConversationsBatchResponsePublicActor:
    ...
    def match_get(self) -> ConversationsBatchResponsePublicActor:
    ...
    def create(self, reqdata: ConversationsBatchResponsePublicActorCreateData, ctrl=None) -> ConversationsBatchResponsePublicActor:
        utility = self._utility
