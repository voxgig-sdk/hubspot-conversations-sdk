...
from hubspotconversations_sdk.core.control import HubspotConversationsControl
...
from hubspotconversations_sdk.core.helpers import get_ctx_prop, to_map
...
class HubspotConversationsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HubspotConversationsControl()
        ...
        if isinstance(sp, HubspotConversationsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HubspotConversationsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HubspotConversationsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HubspotConversationsOperation({})
        ...
        op = HubspotConversationsOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return HubspotConversationsError(code, msg, self)
